...
import { useAppApi as r } from "@kirocrew/app-sdk";
import { Badge as i, Card as a, CardTitle as o, EmptyState as s, PageHeader as c, Skeleton as l, StatCard as u } from "@kirocrew/app-sdk/ui";
import { AlertTriangle as d, Check as f, ChevronRight as p, Search as m } from "lucide-react";
import { Fragment as h, jsx as g, jsxs as _ } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var ee = Object.create, v = Object.defineProperty, te = Object.getOwnPropertyDescriptor, ne = Object.getOwnPropertyNames, re = Object.getPrototypeOf, y = Object.prototype.hasOwnProperty, ie = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), b = (e, t) => {
	let n = {};
	...
	return e;
}, ae = (e, t, n) => (n = e == null ? {} : ee(re(e)), x(t || !e || !e.__esModule || !y.call(e, "default") ? v(n, "default", {
	value: e,
	enumerable: !0
}) : n, e)), S = (e) => e.flatMap(C), C = (e) => D(se(e)).map(oe), oe = (e) => e.replace(/ +/g, " ").trim(), se = (e) => ({
	...
	if (e[t] === "{") return E(e, t + 1);
	if (e[t] === "[") return le(e, t + 1);
	{
		let n = "";
	...
	if (e.type === "concatenation") return e.items.map(D).reduce(ue, [""]);
...
var k = (e) => ({
	...
	text: "«EOF»",
	start: e
}), A = k(Infinity), j = (e) => (t) => t.type === e.type && t.text === e.text, M = {
	ARRAY: j({
		text: "ARRAY",
	...
	"TIME",
	"TIMEZONE"
], ge = S(["SELECT [ALL | DISTINCT] [AS STRUCT | AS VALUE]"]), _e = S([
	"WITH [RECURSIVE]",
	"FROM",
	"WHERE",
	"GROUP BY",
...
]), ve = S(["CREATE [OR REPLACE] [TEMP|TEMPORARY|SNAPSHOT|EXTERNAL] TABLE [IF NOT EXISTS]"]), ye = S(/* @__PURE__ */ "CREATE [OR REPLACE] [MATERIALIZED] VIEW [IF NOT EXISTS].UPDATE.DELETE [FROM].DROP [SNAPSHOT | EXTERNAL] TABLE [IF EXISTS].ALTER TABLE [IF EXISTS].ADD COLUMN [IF NOT EXISTS].DROP COLUMN [IF EXISTS].RENAME TO.ALTER COLUMN [IF EXISTS].SET DEFAULT COLLATE.SET OPTIONS.DROP NOT NULL.SET DATA TYPE.ALTER SCHEMA [IF EXISTS].ALTER [MATERIALIZED] VIEW [IF EXISTS].ALTER BI_CAPACITY.TRUNCATE TABLE.CREATE SCHEMA [IF NOT EXISTS].DEFAULT COLLATE.CREATE [OR REPLACE] [TEMP|TEMPORARY|TABLE] FUNCTION [IF NOT EXISTS].CREATE [OR REPLACE] PROCEDURE [IF NOT EXISTS].CREATE [OR REPLACE] ROW ACCESS POLICY [IF NOT EXISTS].GRANT TO.FILTER USING.CREATE CAPACITY.AS JSON.CREATE RESERVATION.CREATE ASSIGNMENT.CREATE SEARCH INDEX [IF NOT EXISTS].DROP SCHEMA [IF EXISTS].DROP [MATERIALIZED] VIEW [IF EXISTS].DROP [TABLE] FUNCTION [IF EXISTS].DROP PROCEDURE [IF EXISTS].DROP ROW ACCESS POLICY.DROP ALL ROW ACCESS POLICIES.DROP CAPACITY [IF EXISTS].DROP RESERVATION [IF EXISTS].DROP ASSIGNMENT [IF EXISTS].DROP SEARCH INDEX [IF EXISTS].DROP [IF EXISTS].GRANT.REVOKE.DECLARE.EXECUTE IMMEDIATE.LOOP.END LOOP.REPEAT.END REPEAT.WHILE.END WHILE.BREAK.LEAVE.CONTINUE.ITERATE.FOR.END FOR.BEGIN.BEGIN TRANSACTION.COMMIT TRANSACTION.ROLLBACK TRANSACTION.RAISE.RETURN.CALL.ASSERT.EXPORT DATA".split(".")), be = S([
	"UNION {ALL | DISTINCT}",
	"EXCEPT DISTINCT",
	"INTERSECT DISTINCT"
]), xe = S([
...
function Ee(e) {
	let t = A;
	return e.map((e) => e.text === "OFFSET" && t.text === "[" ? (t = e, Object.assign(Object.assign({}, e), { type: O.RESERVED_FUNCTION_NAME })) : (t = e, e));
}
function De(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n];
		if ((M.ARRAY(r) || M.STRUCT(r)) && e[n + 1]?.text === "<") {
			let i = ke(e, n + 1), a = e.slice(n, i + 1);
			t.push({
				type: O.IDENTIFIER,
				raw: a.map(Oe("raw")).join(""),
				text: a.map(Oe("text")).join(""),
				start: r.start
			}), n = i;
		} else t.push(r);
	}
...
var Oe = (e) => (t) => t.type === O.IDENTIFIER || t.type === O.COMMA ? t[e] + " " : t[e];
function ke(e, t) {
	let n = 0;
...
var He = /* @__PURE__ */ "ARRAY_AGG.AVG.CORRELATION.COUNT.COUNT_BIG.COVARIANCE.COVARIANCE_SAMP.CUME_DIST.GROUPING.LISTAGG.MAX.MEDIAN.MIN.PERCENTILE_CONT.PERCENTILE_DISC.PERCENT_RANK.REGR_AVGX.REGR_AVGY.REGR_COUNT.REGR_INTERCEPT.REGR_ICPT.REGR_R2.REGR_SLOPE.REGR_SXX.REGR_SXY.REGR_SYY.STDDEV.STDDEV_SAMP.SUM.VARIANCE.VARIANCE_SAMP.XMLAGG.XMLGROUP.ABS.ABSVAL.ACOS.ADD_DAYS.ADD_HOURS.ADD_MINUTES.ADD_MONTHS.ADD_SECONDS.ADD_YEARS.AGE.ARRAY_DELETE.ARRAY_FIRST.ARRAY_LAST.ARRAY_NEXT.ARRAY_PRIOR.ASCII.ASCII_STR.ASIN.ATAN.ATAN2.ATANH.BITAND.BITANDNOT.BITOR.BITXOR.BITNOT.BPCHAR.BSON_TO_JSON.BTRIM.CARDINALITY.CEILING.CEIL.CHARACTER_LENGTH.CHR.COALESCE.COLLATION_KEY.COLLATION_KEY_BIT.COMPARE_DECFLOAT.CONCAT.COS.COSH.COT.CURSOR_ROWCOUNT.DATAPARTITIONNUM.DATE_PART.DATE_TRUNC.DAY.DAYNAME.DAYOFMONTH.DAYOFWEEK.DAYOFWEEK_ISO.DAYOFYEAR.DAYS.DAYS_BETWEEN.DAYS_TO_END_OF_MONTH.DBPARTITIONNUM.DECFLOAT.DECFLOAT_FORMAT.DECODE.DECRYPT_BIN.DECRYPT_CHAR.DEGREES.DEREF.DIFFERENCE.DIGITS.DOUBLE_PRECISION.EMPTY_BLOB.EMPTY_CLOB.EMPTY_DBCLOB.EMPTY_NCLOB.ENCRYPT.EVENT_MON_STATE.EXP.EXTRACT.FIRST_DAY.FLOOR.FROM_UTC_TIMESTAMP.GENERATE_UNIQUE.GETHINT.GREATEST.HASH.HASH4.HASH8.HASHEDVALUE.HEX.HEXTORAW.HOUR.HOURS_BETWEEN.IDENTITY_VAL_LOCAL.IFNULL.INITCAP.INSERT.INSTR.INSTR2.INSTR4.INSTRB.INTNAND.INTNOR.INTNXOR.INTNNOT.ISNULL.JSON_ARRAY.JSON_OBJECT.JSON_QUERY.JSON_TO_BSON.JSON_VALUE.JULIAN_DAY.LAST_DAY.LCASE.LEAST.LEFT.LENGTH.LENGTH2.LENGTH4.LENGTHB.LN.LOCATE.LOCATE_IN_STRING.LOG10.LONG_VARCHAR.LONG_VARGRAPHIC.LOWER.LPAD.LTRIM.MAX.MAX_CARDINALITY.MICROSECOND.MIDNIGHT_SECONDS.MIN.MINUTE.MINUTES_BETWEEN.MOD.MONTH.MONTHNAME.MONTHS_BETWEEN.MULTIPLY_ALT.NEXT_DAY.NEXT_MONTH.NEXT_QUARTER.NEXT_WEEK.NEXT_YEAR.NORMALIZE_DECFLOAT.NOW.NULLIF.NVL.NVL2.OCTET_LENGTH.OVERLAY.PARAMETER.POSITION.POSSTR.POW.POWER.QUANTIZE.QUARTER.QUOTE_IDENT.QUOTE_LITERAL.RADIANS.RAISE_ERROR.RAND.RANDOM.RAWTOHEX.REC2XML.REGEXP_COUNT.REGEXP_EXTRACT.REGEXP_INSTR.REGEXP_LIKE.REGEXP_MATCH_COUNT.REGEXP_REPLACE.REGEXP_SUBSTR.REPEAT.REPLACE.RID.RID_BIT.RIGHT.ROUND.ROUND_TIMESTAMP.RPAD.RTRIM.SECLABEL.SECLABEL_BY_NAME.SECLABEL_TO_CHAR.SECOND.SECONDS_BETWEEN.SIGN.SIN.SINH.SOUNDEX.SPACE.SQRT.STRIP.STRLEFT.STRPOS.STRRIGHT.SUBSTR.SUBSTR2.SUBSTR4.SUBSTRB.SUBSTRING.TABLE_NAME.TABLE_SCHEMA.TAN.TANH.THIS_MONTH.THIS_QUARTER.THIS_WEEK.THIS_YEAR.TIMESTAMP_FORMAT.TIMESTAMP_ISO.TIMESTAMPDIFF.TIMEZONE.TO_CHAR.TO_CLOB.TO_DATE.TO_HEX.TO_MULTI_BYTE.TO_NCHAR.TO_NCLOB.TO_NUMBER.TO_SINGLE_BYTE.TO_TIMESTAMP.TO_UTC_TIMESTAMP.TOTALORDER.TRANSLATE.TRIM.TRIM_ARRAY.TRUNC_TIMESTAMP.TRUNCATE.TRUNC.TYPE_ID.TYPE_NAME.TYPE_SCHEMA.UCASE.UNICODE_STR.UPPER.VALUE.VARCHAR_BIT_FORMAT.VARCHAR_FORMAT.VARCHAR_FORMAT_BIT.VERIFY_GROUP_FOR_USER.VERIFY_ROLE_FOR_USER.VERIFY_TRUSTED_CONTEXT_ROLE_FOR_USER.WEEK.WEEK_ISO.WEEKS_BETWEEN.WIDTH_BUCKET.XMLATTRIBUTES.XMLCOMMENT.XMLCONCAT.XMLDOCUMENT.XMLELEMENT.XMLFOREST.XMLNAMESPACES.XMLPARSE.XMLPI.XMLQUERY.XMLROW.XMLSERIALIZE.XMLTEXT.XMLVALIDATE.XMLXSROBJECTID.XSLTRANSFORM.YEAR.YEARS_BETWEEN.YMD_BETWEEN.BASE_TABLE.JSON_TABLE.UNNEST.XMLTABLE.RANK.DENSE_RANK.NTILE.LAG.LEAD.ROW_NUMBER.FIRST_VALUE.LAST_VALUE.NTH_VALUE.RATIO_TO_REPORT.CAST".split("."), Ue = /* @__PURE__ */ "ACTIVATE.ADD.AFTER.ALIAS.ALL.ALLOCATE.ALLOW.ALTER.AND.ANY.AS.ASENSITIVE.ASSOCIATE.ASUTIME.AT.ATTRIBUTES.AUDIT.AUTHORIZATION.AUX.AUXILIARY.BEFORE.BEGIN.BETWEEN.BINARY.BUFFERPOOL.BY.CACHE.CALL.CALLED.CAPTURE.CARDINALITY.CASCADED.CASE.CAST.CHECK.CLONE.CLOSE.CLUSTER.COLLECTION.COLLID.COLUMN.COMMENT.COMMIT.CONCAT.CONDITION.CONNECT.CONNECTION.CONSTRAINT.CONTAINS.CONTINUE.COUNT.COUNT_BIG.CREATE.CROSS.CURRENT.CURRENT_DATE.CURRENT_LC_CTYPE.CURRENT_PATH.CURRENT_SCHEMA.CURRENT_SERVER.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_TIMEZONE.CURRENT_USER.CURSOR.CYCLE.DATA.DATABASE.DATAPARTITIONNAME.DATAPARTITIONNUM.DAY.DAYS.DB2GENERAL.DB2GENRL.DB2SQL.DBINFO.DBPARTITIONNAME.DBPARTITIONNUM.DEALLOCATE.DECLARE.DEFAULT.DEFAULTS.DEFINITION.DELETE.DENSERANK.DENSE_RANK.DESCRIBE.DESCRIPTOR.DETERMINISTIC.DIAGNOSTICS.DISABLE.DISALLOW.DISCONNECT.DISTINCT.DO.DOCUMENT.DROP.DSSIZE.DYNAMIC.EACH.EDITPROC.ELSE.ELSEIF.ENABLE.ENCODING.ENCRYPTION.END.END-EXEC.ENDING.ERASE.ESCAPE.EVERY.EXCEPT.EXCEPTION.EXCLUDING.EXCLUSIVE.EXECUTE.EXISTS.EXIT.EXPLAIN.EXTENDED.EXTERNAL.EXTRACT.FENCED.FETCH.FIELDPROC.FILE.FINAL.FIRST1.FOR.FOREIGN.FREE.FROM.FULL.FUNCTION.GENERAL.GENERATED.GET.GLOBAL.GO.GOTO.GRANT.GRAPHIC.GROUP.HANDLER.HASH.HASHED_VALUE.HAVING.HINT.HOLD.HOUR.HOURS.IDENTITY.IF.IMMEDIATE.IMPORT.IN.INCLUDING.INCLUSIVE.INCREMENT.INDEX.INDICATOR.INDICATORS.INF.INFINITY.INHERIT.INNER.INOUT.INSENSITIVE.INSERT.INTEGRITY.INTERSECT.INTO.IS.ISNULL.ISOBID.ISOLATION.ITERATE.JAR.JAVA.JOIN.KEEP.KEY.LABEL.LANGUAGE.LAST3.LATERAL.LC_CTYPE.LEAVE.LEFT.LIKE.LIMIT.LINKTYPE.LOCAL.LOCALDATE.LOCALE.LOCALTIME.LOCALTIMESTAMP.LOCATOR.LOCATORS.LOCK.LOCKMAX.LOCKSIZE.LOOP.MAINTAINED.MATERIALIZED.MAXVALUE.MICROSECOND.MICROSECONDS.MINUTE.MINUTES.MINVALUE.MODE.MODIFIES.MONTH.MONTHS.NAN.NEW.NEW_TABLE.NEXTVAL.NO.NOCACHE.NOCYCLE.NODENAME.NODENUMBER.NOMAXVALUE.NOMINVALUE.NONE.NOORDER.NORMALIZED.NOT2.NOTNULL.NULL.NULLS.NUMPARTS.OBID.OF.OFF.OFFSET.OLD.OLD_TABLE.ON.OPEN.OPTIMIZATION.OPTIMIZE.OPTION.OR.ORDER.OUT.OUTER.OVER.OVERRIDING.PACKAGE.PADDED.PAGESIZE.PARAMETER.PART.PARTITION.PARTITIONED.PARTITIONING.PARTITIONS.PASSWORD.PATH.PERCENT.PIECESIZE.PLAN.POSITION.PRECISION.PREPARE.PREVVAL.PRIMARY.PRIQTY.PRIVILEGES.PROCEDURE.PROGRAM.PSID.PUBLIC.QUERY.QUERYNO.RANGE.RANK.READ.READS.RECOVERY.REFERENCES.REFERENCING.REFRESH.RELEASE.RENAME.REPEAT.RESET.RESIGNAL.RESTART.RESTRICT.RESULT.RESULT_SET_LOCATOR.RETURN.RETURNS.REVOKE.RIGHT.ROLE.ROLLBACK.ROUND_CEILING.ROUND_DOWN.ROUND_FLOOR.ROUND_HALF_DOWN.ROUND_HALF_EVEN.ROUND_HALF_UP.ROUND_UP.ROUTINE.ROW.ROWNUMBER.ROWS.ROWSET.ROW_NUMBER.RRN.RUN.SAVEPOINT.SCHEMA.SCRATCHPAD.SCROLL.SEARCH.SECOND.SECONDS.SECQTY.SECURITY.SELECT.SENSITIVE.SEQUENCE.SESSION.SESSION_USER.SET.SIGNAL.SIMPLE.SNAN.SOME.SOURCE.SPECIFIC.SQL.SQLID.STACKED.STANDARD.START.STARTING.STATEMENT.STATIC.STATMENT.STAY.STOGROUP.STORES.STYLE.SUBSTRING.SUMMARY.SYNONYM.SYSFUN.SYSIBM.SYSPROC.SYSTEM.SYSTEM_USER.TABLE.TABLESPACE.THEN.TO.TRANSACTION.TRIGGER.TRIM.TRUNCATE.TYPE.UNDO.UNION.UNIQUE.UNTIL.UPDATE.USAGE.USER.USING.VALIDPROC.VALUE.VALUES.VARIABLE.VARIANT.VCAT.VERSION.VIEW.VOLATILE.VOLUMES.WHEN.WHENEVER.WHERE.WHILE.WITH.WITHOUT.WLM.WRITE.XMLELEMENT.XMLEXISTS.XMLNAMESPACES.YEAR.YEARS".split("."), We = /* @__PURE__ */ "ARRAY.BIGINT.BINARY.BLOB.BOOLEAN.CCSID.CHAR.CHARACTER.CLOB.DATE.DATETIME.DBCLOB.DEC.DECIMAL.DOUBLE.DOUBLE PRECISION.FLOAT.FLOAT4.FLOAT8.GRAPHIC.INT.INT2.INT4.INT8.INTEGER.INTERVAL.LONG VARCHAR.LONG VARGRAPHIC.NCHAR.NCHR.NCLOB.NVARCHAR.NUMERIC.SMALLINT.REAL.TIME.TIMESTAMP.VARBINARY.VARCHAR.VARGRAPHIC".split("."), Ge = S(["SELECT [ALL | DISTINCT]"]), Ke = S([
	...
	"SIMILAR TO",
	"IS [NOT] DISTINCT FROM"
]), xt = S(["TIMESTAMP WITH TIME ZONE"]), St = {
	name: "duckdb",
	tokenizerOptions: {
		reservedSelect: ht,
		reservedClauses: [
...
]), Ot = S(["CREATE [TEMPORARY] [EXTERNAL] TABLE [IF NOT EXISTS]"]), kt = S([
	...
	"STORED BY",
	"ROW FORMAT"
]), At = S(["UNION [ALL | DISTINCT]"]), jt = S([
	"JOIN",
	"{LEFT | RIGHT | FULL} [OUTER] JOIN",
	"{INNER | CROSS} JOIN",
	"LEFT SEMI JOIN"
]), Mt = S(["{ROWS | RANGE} BETWEEN"]), Nt = S([]), Pt = {
	name: "hive",
	tokenizerOptions: {
		reservedSelect: Et,
		reservedClauses: [
...
function P(e) {
	return e.map((t, n) => {
		let r = e[n + 1] || A;
		if (M.SET(t) && r.text === "(") return Object.assign(Object.assign({}, t), { type: O.RESERVED_FUNCTION_NAME });
		let i = e[n - 1] || A;
		return M.VALUES(t) && i.text === "=" ? Object.assign(Object.assign({}, t), { type: O.RESERVED_FUNCTION_NAME }) : t;
	});
}
//#endregion
//#region node_modules/sql-formatter/dist/esm/languages/mariadb/mariadb.keywords.js
var Ft = /* @__PURE__ */ "ACCESSIBLE.ADD.ALL.ALTER.ANALYZE.AND.AS.ASC.ASENSITIVE.BEFORE.BETWEEN.BOTH.BY.CALL.CASCADE.CASE.CHANGE.CHECK.COLLATE.COLUMN.CONDITION.CONSTRAINT.CONTINUE.CONVERT.CREATE.CROSS.CURRENT_DATE.CURRENT_ROLE.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_USER.CURSOR.DATABASE.DATABASES.DAY_HOUR.DAY_MICROSECOND.DAY_MINUTE.DAY_SECOND.DECLARE.DEFAULT.DELAYED.DELETE.DELETE_DOMAIN_ID.DESC.DESCRIBE.DETERMINISTIC.DISTINCT.DISTINCTROW.DIV.DO_DOMAIN_IDS.DROP.DUAL.EACH.ELSE.ELSEIF.ENCLOSED.ESCAPED.EXCEPT.EXISTS.EXIT.EXPLAIN.FALSE.FETCH.FOR.FORCE.FOREIGN.FROM.FULLTEXT.GENERAL.GRANT.GROUP.HAVING.HIGH_PRIORITY.HOUR_MICROSECOND.HOUR_MINUTE.HOUR_SECOND.IF.IGNORE.IGNORE_DOMAIN_IDS.IGNORE_SERVER_IDS.IN.INDEX.INFILE.INNER.INOUT.INSENSITIVE.INSERT.INTERSECT.INTERVAL.INTO.IS.ITERATE.JOIN.KEY.KEYS.KILL.LEADING.LEAVE.LEFT.LIKE.LIMIT.LINEAR.LINES.LOAD.LOCALTIME.LOCALTIMESTAMP.LOCK.LOOP.LOW_PRIORITY.MASTER_HEARTBEAT_PERIOD.MASTER_SSL_VERIFY_SERVER_CERT.MATCH.MAXVALUE.MINUTE_MICROSECOND.MINUTE_SECOND.MOD.MODIFIES.NATURAL.NOT.NO_WRITE_TO_BINLOG.NULL.OFFSET.ON.OPTIMIZE.OPTION.OPTIONALLY.OR.ORDER.OUT.OUTER.OUTFILE.OVER.PAGE_CHECKSUM.PARSE_VCOL_EXPR.PARTITION.POSITION.PRIMARY.PROCEDURE.PURGE.RANGE.READ.READS.READ_WRITE.RECURSIVE.REF_SYSTEM_ID.REFERENCES.REGEXP.RELEASE.RENAME.REPEAT.REPLACE.REQUIRE.RESIGNAL.RESTRICT.RETURN.RETURNING.REVOKE.RIGHT.RLIKE.ROW_NUMBER.ROWS.SCHEMA.SCHEMAS.SECOND_MICROSECOND.SELECT.SENSITIVE.SEPARATOR.SET.SHOW.SIGNAL.SLOW.SPATIAL.SPECIFIC.SQL.SQLEXCEPTION.SQLSTATE.SQLWARNING.SQL_BIG_RESULT.SQL_CALC_FOUND_ROWS.SQL_SMALL_RESULT.SSL.STARTING.STATS_AUTO_RECALC.STATS_PERSISTENT.STATS_SAMPLE_PAGES.STRAIGHT_JOIN.TABLE.TERMINATED.THEN.TO.TRAILING.TRIGGER.TRUE.UNDO.UNION.UNIQUE.UNLOCK.UNSIGNED.UPDATE.USAGE.USE.USING.UTC_DATE.UTC_TIME.UTC_TIMESTAMP.VALUES.WHEN.WHERE.WHILE.WINDOW.WITH.WRITE.XOR.YEAR_MONTH.ZEROFILL".split("."), It = /* @__PURE__ */ "BIGINT.BINARY.BIT.BLOB.CHAR BYTE.CHAR.CHARACTER.DATETIME.DEC.DECIMAL.DOUBLE PRECISION.DOUBLE.ENUM.FIXED.FLOAT.FLOAT4.FLOAT8.INT.INT1.INT2.INT3.INT4.INT8.INTEGER.LONG.LONGBLOB.LONGTEXT.MEDIUMBLOB.MEDIUMINT.MEDIUMTEXT.MIDDLEINT.NATIONAL CHAR.NATIONAL VARCHAR.NUMERIC.PRECISION.REAL.SMALLINT.TEXT.TIMESTAMP.TINYBLOB.TINYINT.TINYTEXT.VARBINARY.VARCHAR.VARCHARACTER.VARYING.YEAR".split("."), Lt = /* @__PURE__ */ "ADDDATE.ADD_MONTHS.BIT_AND.BIT_OR.BIT_XOR.CAST.COUNT.CUME_DIST.CURDATE.CURTIME.DATE_ADD.DATE_SUB.DATE_FORMAT.DECODE.DENSE_RANK.EXTRACT.FIRST_VALUE.GROUP_CONCAT.JSON_ARRAYAGG.JSON_OBJECTAGG.LAG.LEAD.MAX.MEDIAN.MID.MIN.NOW.NTH_VALUE.NTILE.POSITION.PERCENT_RANK.PERCENTILE_CONT.PERCENTILE_DISC.RANK.ROW_NUMBER.SESSION_USER.STD.STDDEV.STDDEV_POP.STDDEV_SAMP.SUBDATE.SUBSTR.SUBSTRING.SUM.SYSTEM_USER.TRIM.TRIM_ORACLE.VARIANCE.VAR_POP.VAR_SAMP.ABS.ACOS.ADDTIME.AES_DECRYPT.AES_ENCRYPT.ASIN.ATAN.ATAN2.BENCHMARK.BIN.BINLOG_GTID_POS.BIT_COUNT.BIT_LENGTH.CEIL.CEILING.CHARACTER_LENGTH.CHAR_LENGTH.CHR.COERCIBILITY.COLUMN_CHECK.COLUMN_EXISTS.COLUMN_LIST.COLUMN_JSON.COMPRESS.CONCAT.CONCAT_OPERATOR_ORACLE.CONCAT_WS.CONNECTION_ID.CONV.CONVERT_TZ.COS.COT.CRC32.DATEDIFF.DAYNAME.DAYOFMONTH.DAYOFWEEK.DAYOFYEAR.DEGREES.DECODE_HISTOGRAM.DECODE_ORACLE.DES_DECRYPT.DES_ENCRYPT.ELT.ENCODE.ENCRYPT.EXP.EXPORT_SET.EXTRACTVALUE.FIELD.FIND_IN_SET.FLOOR.FORMAT.FOUND_ROWS.FROM_BASE64.FROM_DAYS.FROM_UNIXTIME.GET_LOCK.GREATEST.HEX.IFNULL.INSTR.ISNULL.IS_FREE_LOCK.IS_USED_LOCK.JSON_ARRAY.JSON_ARRAY_APPEND.JSON_ARRAY_INSERT.JSON_COMPACT.JSON_CONTAINS.JSON_CONTAINS_PATH.JSON_DEPTH.JSON_DETAILED.JSON_EXISTS.JSON_EXTRACT.JSON_INSERT.JSON_KEYS.JSON_LENGTH.JSON_LOOSE.JSON_MERGE.JSON_MERGE_PATCH.JSON_MERGE_PRESERVE.JSON_QUERY.JSON_QUOTE.JSON_OBJECT.JSON_REMOVE.JSON_REPLACE.JSON_SET.JSON_SEARCH.JSON_TYPE.JSON_UNQUOTE.JSON_VALID.JSON_VALUE.LAST_DAY.LAST_INSERT_ID.LCASE.LEAST.LENGTH.LENGTHB.LN.LOAD_FILE.LOCATE.LOG.LOG10.LOG2.LOWER.LPAD.LPAD_ORACLE.LTRIM.LTRIM_ORACLE.MAKEDATE.MAKETIME.MAKE_SET.MASTER_GTID_WAIT.MASTER_POS_WAIT.MD5.MONTHNAME.NAME_CONST.NVL.NVL2.OCT.OCTET_LENGTH.ORD.PERIOD_ADD.PERIOD_DIFF.PI.POW.POWER.QUOTE.REGEXP_INSTR.REGEXP_REPLACE.REGEXP_SUBSTR.RADIANS.RAND.RELEASE_ALL_LOCKS.RELEASE_LOCK.REPLACE_ORACLE.REVERSE.ROUND.RPAD.RPAD_ORACLE.RTRIM.RTRIM_ORACLE.SEC_TO_TIME.SHA.SHA1.SHA2.SIGN.SIN.SLEEP.SOUNDEX.SPACE.SQRT.STRCMP.STR_TO_DATE.SUBSTR_ORACLE.SUBSTRING_INDEX.SUBTIME.SYS_GUID.TAN.TIMEDIFF.TIME_FORMAT.TIME_TO_SEC.TO_BASE64.TO_CHAR.TO_DAYS.TO_SECONDS.UCASE.UNCOMPRESS.UNCOMPRESSED_LENGTH.UNHEX.UNIX_TIMESTAMP.UPDATEXML.UPPER.UUID.UUID_SHORT.VERSION.WEEKDAY.WEEKOFYEAR.WSREP_LAST_WRITTEN_GTID.WSREP_LAST_SEEN_GTID.WSREP_SYNC_WAIT_UPTO_GTID.YEARWEEK.COALESCE.NULLIF".split("."), Rt = S(["SELECT [ALL | DISTINCT | DISTINCTROW]"]), zt = S([
	"WITH [RECURSIVE]",
	"FROM",
	"WHERE",
	"GROUP BY",
	...
	"ON DUPLICATE KEY UPDATE",
	"SET"
]), dn = S(["CREATE [TEMPORARY] TABLE [IF NOT EXISTS]"]), fn = S(/* @__PURE__ */ "CREATE [OR REPLACE] [SQL SECURITY DEFINER | SQL SECURITY INVOKER] VIEW [IF NOT EXISTS].UPDATE [LOW_PRIORITY] [IGNORE].DELETE [LOW_PRIORITY] [QUICK] [IGNORE] FROM.DROP [TEMPORARY] TABLE [IF EXISTS].ALTER TABLE.ADD [COLUMN].{CHANGE | MODIFY} [COLUMN].DROP [COLUMN].RENAME [TO | AS].RENAME COLUMN.ALTER [COLUMN].{SET | DROP} DEFAULT.TRUNCATE [TABLE].ALTER DATABASE.ALTER INSTANCE.ALTER RESOURCE GROUP.ALTER SEQUENCE.ALTER USER.ALTER VIEW.ANALYZE TABLE.CHECK TABLE.CHECKSUM TABLE.COMMIT.CREATE DATABASE.CREATE INDEX.CREATE RESOURCE GROUP.CREATE ROLE.CREATE SEQUENCE.CREATE USER.DEALLOCATE PREPARE.DESCRIBE.DROP DATABASE.DROP INDEX.DROP RESOURCE GROUP.DROP ROLE.DROP TABLESPACE.DROP USER.DROP VIEW.EXPLAIN.FLUSH.GRANT.IMPORT TABLE.INSTALL COMPONENT.INSTALL PLUGIN.KILL.LOAD DATA.LOCK INSTANCE FOR BACKUP.LOCK TABLES.OPTIMIZE TABLE.PREPARE.RELEASE SAVEPOINT.RENAME TABLE.RENAME USER.REPAIR TABLE.RESET.REVOKE.ROLLBACK.ROLLBACK TO SAVEPOINT.SAVEPOINT.SET CHARACTER SET.SET DEFAULT ROLE.SET NAMES.SET PASSWORD.SET RESOURCE GROUP.SET ROLE.SET TRANSACTION.SHOW.SHOW BINARY LOGS.SHOW BINLOG EVENTS.SHOW CHARACTER SET.SHOW COLLATION.SHOW COLUMNS.SHOW CREATE DATABASE.SHOW CREATE TABLE.SHOW CREATE USER.SHOW CREATE VIEW.SHOW DATABASES.SHOW ENGINE.SHOW ENGINES.SHOW ERRORS.SHOW EVENTS.SHOW GRANTS.SHOW INDEX.SHOW MASTER STATUS.SHOW OPEN TABLES.SHOW PLUGINS.SHOW PRIVILEGES.SHOW PROCESSLIST.SHOW PROFILE.SHOW PROFILES.SHOW STATUS.SHOW TABLE STATUS.SHOW TABLES.SHOW TRIGGERS.SHOW VARIABLES.SHOW WARNINGS.TABLE.UNINSTALL COMPONENT.UNINSTALL PLUGIN.UNLOCK INSTANCE.UNLOCK TABLES.USE".split(".")), pn = S(["UNION [ALL | DISTINCT]"]), mn = S([
	"JOIN",
	"{LEFT | RIGHT} [OUTER] JOIN",
	"{INNER | CROSS} JOIN",
	"NATURAL [INNER] JOIN",
	...
	tokenizerOptions: {
		...
		reservedSetOperations: pn,
		reservedJoins: mn,
		reservedKeywordPhrases: hn,
		reservedDataTypePhrases: gn,
		supportsXor: !0,
		reservedKeywords: on,
	...
	"UNNEST",
	"RETURNING"
]), Cn = S(/* @__PURE__ */ "UPDATE.DELETE FROM.SET SCHEMA.ADVISE.ALTER INDEX.BEGIN TRANSACTION.BUILD INDEX.COMMIT TRANSACTION.CREATE COLLECTION.CREATE FUNCTION.CREATE INDEX.CREATE PRIMARY INDEX.CREATE SCOPE.DROP COLLECTION.DROP FUNCTION.DROP INDEX.DROP PRIMARY INDEX.DROP SCOPE.EXECUTE.EXECUTE FUNCTION.EXPLAIN.GRANT.INFER.PREPARE.REVOKE.ROLLBACK TRANSACTION.SAVEPOINT.SET TRANSACTION.UPDATE STATISTICS.UPSERT.LET.SET CURRENT SCHEMA.SHOW.USE [PRIMARY] KEYS".split(".")), wn = S([
	"UNION [ALL]",
	"EXCEPT [ALL]",
	"INTERSECT [ALL]"
]), Tn = S([
	...
	"{LEFT | RIGHT} [OUTER] JOIN",
	"INNER JOIN"
]), En = S(["{ROWS | RANGE | GROUPS} BETWEEN"]), Dn = S([]), On = {
	name: "n1ql",
	tokenizerOptions: {
		reservedSelect: xn,
		reservedClauses: [...Sn, ...Cn],
	...
	formatOptions: { onelineClauses: Cn }
}, kn = /* @__PURE__ */ "ADD.AGENT.AGGREGATE.ALL.ALTER.AND.ANY.ARROW.AS.ASC.AT.ATTRIBUTE.AUTHID.AVG.BEGIN.BETWEEN.BLOCK.BODY.BOTH.BOUND.BULK.BY.BYTE.CALL.CALLING.CASCADE.CASE.CHARSET.CHARSETFORM.CHARSETID.CHECK.CLOSE.CLUSTER.CLUSTERS.COLAUTH.COLLECT.COLUMNS.COMMENT.COMMIT.COMMITTED.COMPILED.COMPRESS.CONNECT.CONSTANT.CONSTRUCTOR.CONTEXT.CONVERT.COUNT.CRASH.CREATE.CURRENT.CURSOR.CUSTOMDATUM.DANGLING.DATA.DAY.DECLARE.DEFAULT.DEFINE.DELETE.DESC.DETERMINISTIC.DISTINCT.DROP.DURATION.ELEMENT.ELSE.ELSIF.EMPTY.END.ESCAPE.EXCEPT.EXCEPTION.EXCEPTIONS.EXCLUSIVE.EXECUTE.EXISTS.EXIT.EXTERNAL.FETCH.FINAL.FIXED.FOR.FORALL.FORCE.FORM.FROM.FUNCTION.GENERAL.GOTO.GRANT.GROUP.HASH.HAVING.HEAP.HIDDEN.HOUR.IDENTIFIED.IF.IMMEDIATE.IN.INCLUDING.INDEX.INDEXES.INDICATOR.INDICES.INFINITE.INSERT.INSTANTIABLE.INTERFACE.INTERSECT.INTERVAL.INTO.INVALIDATE.IS.ISOLATION.JAVA.LANGUAGE.LARGE.LEADING.LENGTH.LEVEL.LIBRARY.LIKE.LIKE2.LIKE4.LIKEC.LIMIT.LIMITED.LOCAL.LOCK.LOOP.MAP.MAX.MAXLEN.MEMBER.MERGE.MIN.MINUS.MINUTE.MOD.MODE.MODIFY.MONTH.MULTISET.NAME.NAN.NATIONAL.NATIVE.NEW.NOCOMPRESS.NOCOPY.NOT.NOWAIT.NULL.OBJECT.OCICOLL.OCIDATE.OCIDATETIME.OCIDURATION.OCIINTERVAL.OCILOBLOCATOR.OCINUMBER.OCIRAW.OCIREF.OCIREFCURSOR.OCIROWID.OCISTRING.OCITYPE.OF.ON.ONLY.OPAQUE.OPEN.OPERATOR.OPTION.OR.ORACLE.ORADATA.ORDER.OVERLAPS.ORGANIZATION.ORLANY.ORLVARY.OTHERS.OUT.OVERRIDING.PACKAGE.PARALLEL_ENABLE.PARAMETER.PARAMETERS.PARTITION.PASCAL.PIPE.PIPELINED.PRAGMA.PRIOR.PRIVATE.PROCEDURE.PUBLIC.RAISE.RANGE.READ.RECORD.REF.REFERENCE.REM.REMAINDER.RENAME.RESOURCE.RESULT.RETURN.RETURNING.REVERSE.REVOKE.ROLLBACK.ROW.SAMPLE.SAVE.SAVEPOINT.SB1.SB2.SB4.SECOND.SEGMENT.SELECT.SELF.SEPARATE.SEQUENCE.SERIALIZABLE.SET.SHARE.SHORT.SIZE.SIZE_T.SOME.SPARSE.SQL.SQLCODE.SQLDATA.SQLNAME.SQLSTATE.STANDARD.START.STATIC.STDDEV.STORED.STRING.STRUCT.STYLE.SUBMULTISET.SUBPARTITION.SUBSTITUTABLE.SUBTYPE.SUM.SYNONYM.TABAUTH.TABLE.TDO.THE.THEN.TIME.TIMEZONE_ABBR.TIMEZONE_HOUR.TIMEZONE_MINUTE.TIMEZONE_REGION.TO.TRAILING.TRANSAC.TRANSACTIONAL.TRUSTED.TYPE.UB1.UB2.UB4.UNDER.UNION.UNIQUE.UNSIGNED.UNTRUSTED.UPDATE.USE.USING.VALIST.VALUE.VALUES.VARIABLE.VARIANCE.VARRAY.VIEW.VIEWS.VOID.WHEN.WHERE.WHILE.WITH.WORK.WRAPPED.WRITE.YEAR.ZONE".split("."), An = /* @__PURE__ */ "ARRAY.BFILE_BASE.BINARY.BLOB_BASE.CHAR VARYING.CHAR_BASE.CHAR.CHARACTER VARYING.CHARACTER.CLOB_BASE.DATE_BASE.DATE.DECIMAL.DOUBLE.FLOAT.INT.INTERVAL DAY.INTERVAL YEAR.LONG.NATIONAL CHAR VARYING.NATIONAL CHAR.NATIONAL CHARACTER VARYING.NATIONAL CHARACTER.NCHAR VARYING.NCHAR.NCHAR.NUMBER_BASE.NUMBER.NUMBERIC.NVARCHAR.PRECISION.RAW.TIMESTAMP.UROWID.VARCHAR.VARCHAR2".split("."), jn = /* @__PURE__ */ "ABS.ACOS.ASIN.ATAN.ATAN2.BITAND.CEIL.COS.COSH.EXP.FLOOR.LN.LOG.MOD.NANVL.POWER.REMAINDER.ROUND.SIGN.SIN.SINH.SQRT.TAN.TANH.TRUNC.WIDTH_BUCKET.CHR.CONCAT.INITCAP.LOWER.LPAD.LTRIM.NLS_INITCAP.NLS_LOWER.NLSSORT.NLS_UPPER.REGEXP_REPLACE.REGEXP_SUBSTR.REPLACE.RPAD.RTRIM.SOUNDEX.SUBSTR.TRANSLATE.TREAT.TRIM.UPPER.NLS_CHARSET_DECL_LEN.NLS_CHARSET_ID.NLS_CHARSET_NAME.ASCII.INSTR.LENGTH.REGEXP_INSTR.ADD_MONTHS.CURRENT_DATE.CURRENT_TIMESTAMP.DBTIMEZONE.EXTRACT.FROM_TZ.LAST_DAY.LOCALTIMESTAMP.MONTHS_BETWEEN.NEW_TIME.NEXT_DAY.NUMTODSINTERVAL.NUMTOYMINTERVAL.ROUND.SESSIONTIMEZONE.SYS_EXTRACT_UTC.SYSDATE.SYSTIMESTAMP.TO_CHAR.TO_TIMESTAMP.TO_TIMESTAMP_TZ.TO_DSINTERVAL.TO_YMINTERVAL.TRUNC.TZ_OFFSET.GREATEST.LEAST.ASCIISTR.BIN_TO_NUM.CAST.CHARTOROWID.COMPOSE.CONVERT.DECOMPOSE.HEXTORAW.NUMTODSINTERVAL.NUMTOYMINTERVAL.RAWTOHEX.RAWTONHEX.ROWIDTOCHAR.ROWIDTONCHAR.SCN_TO_TIMESTAMP.TIMESTAMP_TO_SCN.TO_BINARY_DOUBLE.TO_BINARY_FLOAT.TO_CHAR.TO_CLOB.TO_DATE.TO_DSINTERVAL.TO_LOB.TO_MULTI_BYTE.TO_NCHAR.TO_NCLOB.TO_NUMBER.TO_DSINTERVAL.TO_SINGLE_BYTE.TO_TIMESTAMP.TO_TIMESTAMP_TZ.TO_YMINTERVAL.TO_YMINTERVAL.TRANSLATE.UNISTR.BFILENAME.EMPTY_BLOB,.EMPTY_CLOB.CARDINALITY.COLLECT.POWERMULTISET.POWERMULTISET_BY_CARDINALITY.SET.SYS_CONNECT_BY_PATH.CLUSTER_ID.CLUSTER_PROBABILITY.CLUSTER_SET.FEATURE_ID.FEATURE_SET.FEATURE_VALUE.PREDICTION.PREDICTION_COST.PREDICTION_DETAILS.PREDICTION_PROBABILITY.PREDICTION_SET.APPENDCHILDXML.DELETEXML.DEPTH.EXTRACT.EXISTSNODE.EXTRACTVALUE.INSERTCHILDXML.INSERTXMLBEFORE.PATH.SYS_DBURIGEN.SYS_XMLAGG.SYS_XMLGEN.UPDATEXML.XMLAGG.XMLCDATA.XMLCOLATTVAL.XMLCOMMENT.XMLCONCAT.XMLFOREST.XMLPARSE.XMLPI.XMLQUERY.XMLROOT.XMLSEQUENCE.XMLSERIALIZE.XMLTABLE.XMLTRANSFORM.DECODE.DUMP.ORA_HASH.VSIZE.COALESCE.LNNVL.NULLIF.NVL.NVL2.SYS_CONTEXT.SYS_GUID.SYS_TYPEID.UID.USER.USERENV.AVG.COLLECT.CORR.CORR_S.CORR_K.COUNT.COVAR_POP.COVAR_SAMP.CUME_DIST.DENSE_RANK.FIRST.GROUP_ID.GROUPING.GROUPING_ID.LAST.MAX.MEDIAN.MIN.PERCENTILE_CONT.PERCENTILE_DISC.PERCENT_RANK.RANK.REGR_SLOPE.REGR_INTERCEPT.REGR_COUNT.REGR_R2.REGR_AVGX.REGR_AVGY.REGR_SXX.REGR_SYY.REGR_SXY.STATS_BINOMIAL_TEST.STATS_CROSSTAB.STATS_F_TEST.STATS_KS_TEST.STATS_MODE.STATS_MW_TEST.STATS_ONE_WAY_ANOVA.STATS_T_TEST_ONE.STATS_T_TEST_PAIRED.STATS_T_TEST_INDEP.STATS_T_TEST_INDEPU.STATS_WSR_TEST.STDDEV.STDDEV_POP.STDDEV_SAMP.SUM.VAR_POP.VAR_SAMP.VARIANCE.FIRST_VALUE.LAG.LAST_VALUE.LEAD.NTILE.RATIO_TO_REPORT.ROW_NUMBER.DEREF.MAKE_REF.REF.REFTOHEX.VALUE.CV.ITERATION_NUMBER.PRESENTNNV.PRESENTV.PREVIOUS".split("."), Mn = S(["SELECT [ALL | DISTINCT | UNIQUE]"]), Nn = S([
	"WITH",
	"FROM",
	"WHERE",
	"GROUP BY",
	...
	"UPDATE SET",
	"RETURNING"
]), Pn = S(["CREATE [GLOBAL TEMPORARY | PRIVATE TEMPORARY | SHARDED | DUPLICATED | IMMUTABLE BLOCKCHAIN | BLOCKCHAIN | IMMUTABLE] TABLE"]), Fn = S([
	...
	tokenizerOptions: {
		...
		supportsXor: !0,
		reservedKeywords: kn,
		reservedDataTypes: An,
		reservedFunctionNames: jn,
		stringTypes: [{
			quote: "''-qq",
			prefixes: ["N"]
		}, {
...
var Hn = /* @__PURE__ */ "ABS.ACOS.ACOSD.ACOSH.ASIN.ASIND.ASINH.ATAN.ATAN2.ATAN2D.ATAND.ATANH.CBRT.CEIL.CEILING.COS.COSD.COSH.COT.COTD.DEGREES.DIV.EXP.FACTORIAL.FLOOR.GCD.LCM.LN.LOG.LOG10.MIN_SCALE.MOD.PI.POWER.RADIANS.RANDOM.ROUND.SCALE.SETSEED.SIGN.SIN.SIND.SINH.SQRT.TAN.TAND.TANH.TRIM_SCALE.TRUNC.WIDTH_BUCKET.ABS.ASCII.BIT_LENGTH.BTRIM.CHARACTER_LENGTH.CHAR_LENGTH.CHR.CONCAT.CONCAT_WS.FORMAT.INITCAP.LEFT.LENGTH.LOWER.LPAD.LTRIM.MD5.NORMALIZE.OCTET_LENGTH.OVERLAY.PARSE_IDENT.PG_CLIENT_ENCODING.POSITION.QUOTE_IDENT.QUOTE_LITERAL.QUOTE_NULLABLE.REGEXP_MATCH.REGEXP_MATCHES.REGEXP_REPLACE.REGEXP_SPLIT_TO_ARRAY.REGEXP_SPLIT_TO_TABLE.REPEAT.REPLACE.REVERSE.RIGHT.RPAD.RTRIM.SPLIT_PART.SPRINTF.STARTS_WITH.STRING_AGG.STRING_TO_ARRAY.STRING_TO_TABLE.STRPOS.SUBSTR.SUBSTRING.TO_ASCII.TO_HEX.TRANSLATE.TRIM.UNISTR.UPPER.BIT_COUNT.BIT_LENGTH.BTRIM.CONVERT.CONVERT_FROM.CONVERT_TO.DECODE.ENCODE.GET_BIT.GET_BYTE.LENGTH.LTRIM.MD5.OCTET_LENGTH.OVERLAY.POSITION.RTRIM.SET_BIT.SET_BYTE.SHA224.SHA256.SHA384.SHA512.STRING_AGG.SUBSTR.SUBSTRING.TRIM.BIT_COUNT.BIT_LENGTH.GET_BIT.LENGTH.OCTET_LENGTH.OVERLAY.POSITION.SET_BIT.SUBSTRING.REGEXP_MATCH.REGEXP_MATCHES.REGEXP_REPLACE.REGEXP_SPLIT_TO_ARRAY.REGEXP_SPLIT_TO_TABLE.TO_CHAR.TO_DATE.TO_NUMBER.TO_TIMESTAMP.CLOCK_TIMESTAMP.CURRENT_DATE.CURRENT_TIME.CURRENT_TIMESTAMP.DATE_BIN.DATE_PART.DATE_TRUNC.EXTRACT.ISFINITE.JUSTIFY_DAYS.JUSTIFY_HOURS.JUSTIFY_INTERVAL.LOCALTIME.LOCALTIMESTAMP.MAKE_DATE.MAKE_INTERVAL.MAKE_TIME.MAKE_TIMESTAMP.MAKE_TIMESTAMPTZ.NOW.PG_SLEEP.PG_SLEEP_FOR.PG_SLEEP_UNTIL.STATEMENT_TIMESTAMP.TIMEOFDAY.TO_TIMESTAMP.TRANSACTION_TIMESTAMP.ENUM_FIRST.ENUM_LAST.ENUM_RANGE.AREA.BOUND_BOX.BOX.CENTER.CIRCLE.DIAGONAL.DIAMETER.HEIGHT.ISCLOSED.ISOPEN.LENGTH.LINE.LSEG.NPOINTS.PATH.PCLOSE.POINT.POLYGON.POPEN.RADIUS.SLOPE.WIDTH.ABBREV.BROADCAST.FAMILY.HOST.HOSTMASK.INET_MERGE.INET_SAME_FAMILY.MACADDR8_SET7BIT.MASKLEN.NETMASK.NETWORK.SET_MASKLEN.TRUNC.ARRAY_TO_TSVECTOR.GET_CURRENT_TS_CONFIG.JSONB_TO_TSVECTOR.JSON_TO_TSVECTOR.LENGTH.NUMNODE.PHRASETO_TSQUERY.PLAINTO_TSQUERY.QUERYTREE.SETWEIGHT.STRIP.TO_TSQUERY.TO_TSVECTOR.TSQUERY_PHRASE.TSVECTOR_TO_ARRAY.TS_DEBUG.TS_DELETE.TS_FILTER.TS_HEADLINE.TS_LEXIZE.TS_PARSE.TS_RANK.TS_RANK_CD.TS_REWRITE.TS_STAT.TS_TOKEN_TYPE.WEBSEARCH_TO_TSQUERY.GEN_RANDOM_UUID.UUIDV4.UUIDV7.UUID_EXTRACT_TIMESTAMP.UUID_EXTRACT_VERSION.CURSOR_TO_XML.CURSOR_TO_XMLSCHEMA.DATABASE_TO_XML.DATABASE_TO_XMLSCHEMA.DATABASE_TO_XML_AND_XMLSCHEMA.NEXTVAL.QUERY_TO_XML.QUERY_TO_XMLSCHEMA.QUERY_TO_XML_AND_XMLSCHEMA.SCHEMA_TO_XML.SCHEMA_TO_XMLSCHEMA.SCHEMA_TO_XML_AND_XMLSCHEMA.STRING.TABLE_TO_XML.TABLE_TO_XMLSCHEMA.TABLE_TO_XML_AND_XMLSCHEMA.XMLAGG.XMLCOMMENT.XMLCONCAT.XMLELEMENT.XMLEXISTS.XMLFOREST.XMLPARSE.XMLPI.XMLROOT.XMLSERIALIZE.XMLTABLE.XML_IS_WELL_FORMED.XML_IS_WELL_FORMED_CONTENT.XML_IS_WELL_FORMED_DOCUMENT.XPATH.XPATH_EXISTS.ARRAY_TO_JSON.JSONB_AGG.JSONB_ARRAY_ELEMENTS.JSONB_ARRAY_ELEMENTS_TEXT.JSONB_ARRAY_LENGTH.JSONB_BUILD_ARRAY.JSONB_BUILD_OBJECT.JSONB_EACH.JSONB_EACH_TEXT.JSONB_EXTRACT_PATH.JSONB_EXTRACT_PATH_TEXT.JSONB_INSERT.JSONB_OBJECT.JSONB_OBJECT_AGG.JSONB_OBJECT_KEYS.JSONB_PATH_EXISTS.JSONB_PATH_EXISTS_TZ.JSONB_PATH_MATCH.JSONB_PATH_MATCH_TZ.JSONB_PATH_QUERY.JSONB_PATH_QUERY_ARRAY.JSONB_PATH_QUERY_ARRAY_TZ.JSONB_PATH_QUERY_FIRST.JSONB_PATH_QUERY_FIRST_TZ.JSONB_PATH_QUERY_TZ.JSONB_POPULATE_RECORD.JSONB_POPULATE_RECORDSET.JSONB_PRETTY.JSONB_SET.JSONB_SET_LAX.JSONB_STRIP_NULLS.JSONB_TO_RECORD.JSONB_TO_RECORDSET.JSONB_TYPEOF.JSON_AGG.JSON_ARRAY_ELEMENTS.JSON_ARRAY_ELEMENTS_TEXT.JSON_ARRAY_LENGTH.JSON_BUILD_ARRAY.JSON_BUILD_OBJECT.JSON_EACH.JSON_EACH_TEXT.JSON_EXTRACT_PATH.JSON_EXTRACT_PATH_TEXT.JSON_OBJECT.JSON_OBJECT_AGG.JSON_OBJECT_KEYS.JSON_POPULATE_RECORD.JSON_POPULATE_RECORDSET.JSON_STRIP_NULLS.JSON_TO_RECORD.JSON_TO_RECORDSET.JSON_TYPEOF.ROW_TO_JSON.TO_JSON.TO_JSONB.TO_TIMESTAMP.CURRVAL.LASTVAL.NEXTVAL.SETVAL.COALESCE.GREATEST.LEAST.NULLIF.ARRAY_AGG.ARRAY_APPEND.ARRAY_CAT.ARRAY_DIMS.ARRAY_FILL.ARRAY_LENGTH.ARRAY_LOWER.ARRAY_NDIMS.ARRAY_POSITION.ARRAY_POSITIONS.ARRAY_PREPEND.ARRAY_REMOVE.ARRAY_REPLACE.ARRAY_TO_STRING.ARRAY_UPPER.CARDINALITY.STRING_TO_ARRAY.TRIM_ARRAY.UNNEST.ISEMPTY.LOWER.LOWER_INC.LOWER_INF.MULTIRANGE.RANGE_MERGE.UPPER.UPPER_INC.UPPER_INF.ARRAY_AGG.AVG.BIT_AND.BIT_OR.BIT_XOR.BOOL_AND.BOOL_OR.COALESCE.CORR.COUNT.COVAR_POP.COVAR_SAMP.CUME_DIST.DENSE_RANK.EVERY.GROUPING.JSONB_AGG.JSONB_OBJECT_AGG.JSON_AGG.JSON_OBJECT_AGG.MAX.MIN.MODE.PERCENTILE_CONT.PERCENTILE_DISC.PERCENT_RANK.RANGE_AGG.RANGE_INTERSECT_AGG.RANK.REGR_AVGX.REGR_AVGY.REGR_COUNT.REGR_INTERCEPT.REGR_R2.REGR_SLOPE.REGR_SXX.REGR_SXY.REGR_SYY.STDDEV.STDDEV_POP.STDDEV_SAMP.STRING_AGG.SUM.TO_JSON.TO_JSONB.VARIANCE.VAR_POP.VAR_SAMP.XMLAGG.CUME_DIST.DENSE_RANK.FIRST_VALUE.LAG.LAST_VALUE.LEAD.NTH_VALUE.NTILE.PERCENT_RANK.RANK.ROW_NUMBER.GENERATE_SERIES.GENERATE_SUBSCRIPTS.ACLDEFAULT.ACLEXPLODE.COL_DESCRIPTION.CURRENT_CATALOG.CURRENT_DATABASE.CURRENT_QUERY.CURRENT_ROLE.CURRENT_SCHEMA.CURRENT_SCHEMAS.CURRENT_USER.FORMAT_TYPE.HAS_ANY_COLUMN_PRIVILEGE.HAS_COLUMN_PRIVILEGE.HAS_DATABASE_PRIVILEGE.HAS_FOREIGN_DATA_WRAPPER_PRIVILEGE.HAS_FUNCTION_PRIVILEGE.HAS_LANGUAGE_PRIVILEGE.HAS_SCHEMA_PRIVILEGE.HAS_SEQUENCE_PRIVILEGE.HAS_SERVER_PRIVILEGE.HAS_TABLESPACE_PRIVILEGE.HAS_TABLE_PRIVILEGE.HAS_TYPE_PRIVILEGE.INET_CLIENT_ADDR.INET_CLIENT_PORT.INET_SERVER_ADDR.INET_SERVER_PORT.MAKEACLITEM.OBJ_DESCRIPTION.PG_BACKEND_PID.PG_BLOCKING_PIDS.PG_COLLATION_IS_VISIBLE.PG_CONF_LOAD_TIME.PG_CONTROL_CHECKPOINT.PG_CONTROL_INIT.PG_CONTROL_SYSTEM.PG_CONVERSION_IS_VISIBLE.PG_CURRENT_LOGFILE.PG_CURRENT_SNAPSHOT.PG_CURRENT_XACT_ID.PG_CURRENT_XACT_ID_IF_ASSIGNED.PG_DESCRIBE_OBJECT.PG_FUNCTION_IS_VISIBLE.PG_GET_CATALOG_FOREIGN_KEYS.PG_GET_CONSTRAINTDEF.PG_GET_EXPR.PG_GET_FUNCTIONDEF.PG_GET_FUNCTION_ARGUMENTS.PG_GET_FUNCTION_IDENTITY_ARGUMENTS.PG_GET_FUNCTION_RESULT.PG_GET_INDEXDEF.PG_GET_KEYWORDS.PG_GET_OBJECT_ADDRESS.PG_GET_OWNED_SEQUENCE.PG_GET_RULEDEF.PG_GET_SERIAL_SEQUENCE.PG_GET_STATISTICSOBJDEF.PG_GET_TRIGGERDEF.PG_GET_USERBYID.PG_GET_VIEWDEF.PG_HAS_ROLE.PG_IDENTIFY_OBJECT.PG_IDENTIFY_OBJECT_AS_ADDRESS.PG_INDEXAM_HAS_PROPERTY.PG_INDEX_COLUMN_HAS_PROPERTY.PG_INDEX_HAS_PROPERTY.PG_IS_OTHER_TEMP_SCHEMA.PG_JIT_AVAILABLE.PG_LAST_COMMITTED_XACT.PG_LISTENING_CHANNELS.PG_MY_TEMP_SCHEMA.PG_NOTIFICATION_QUEUE_USAGE.PG_OPCLASS_IS_VISIBLE.PG_OPERATOR_IS_VISIBLE.PG_OPFAMILY_IS_VISIBLE.PG_OPTIONS_TO_TABLE.PG_POSTMASTER_START_TIME.PG_SAFE_SNAPSHOT_BLOCKING_PIDS.PG_SNAPSHOT_XIP.PG_SNAPSHOT_XMAX.PG_SNAPSHOT_XMIN.PG_STATISTICS_OBJ_IS_VISIBLE.PG_TABLESPACE_DATABASES.PG_TABLESPACE_LOCATION.PG_TABLE_IS_VISIBLE.PG_TRIGGER_DEPTH.PG_TS_CONFIG_IS_VISIBLE.PG_TS_DICT_IS_VISIBLE.PG_TS_PARSER_IS_VISIBLE.PG_TS_TEMPLATE_IS_VISIBLE.PG_TYPEOF.PG_TYPE_IS_VISIBLE.PG_VISIBLE_IN_SNAPSHOT.PG_XACT_COMMIT_TIMESTAMP.PG_XACT_COMMIT_TIMESTAMP_ORIGIN.PG_XACT_STATUS.PQSERVERVERSION.ROW_SECURITY_ACTIVE.SESSION_USER.SHOBJ_DESCRIPTION.TO_REGCLASS.TO_REGCOLLATION.TO_REGNAMESPACE.TO_REGOPER.TO_REGOPERATOR.TO_REGPROC.TO_REGPROCEDURE.TO_REGROLE.TO_REGTYPE.TXID_CURRENT.TXID_CURRENT_IF_ASSIGNED.TXID_CURRENT_SNAPSHOT.TXID_SNAPSHOT_XIP.TXID_SNAPSHOT_XMAX.TXID_SNAPSHOT_XMIN.TXID_STATUS.TXID_VISIBLE_IN_SNAPSHOT.USER.VERSION.BRIN_DESUMMARIZE_RANGE.BRIN_SUMMARIZE_NEW_VALUES.BRIN_SUMMARIZE_RANGE.CONVERT_FROM.CURRENT_SETTING.GIN_CLEAN_PENDING_LIST.PG_ADVISORY_LOCK.PG_ADVISORY_LOCK_SHARED.PG_ADVISORY_UNLOCK.PG_ADVISORY_UNLOCK_ALL.PG_ADVISORY_UNLOCK_SHARED.PG_ADVISORY_XACT_LOCK.PG_ADVISORY_XACT_LOCK_SHARED.PG_BACKUP_START_TIME.PG_CANCEL_BACKEND.PG_COLLATION_ACTUAL_VERSION.PG_COLUMN_COMPRESSION.PG_COLUMN_SIZE.PG_COPY_LOGICAL_REPLICATION_SLOT.PG_COPY_PHYSICAL_REPLICATION_SLOT.PG_CREATE_LOGICAL_REPLICATION_SLOT.PG_CREATE_PHYSICAL_REPLICATION_SLOT.PG_CREATE_RESTORE_POINT.PG_CURRENT_WAL_FLUSH_LSN.PG_CURRENT_WAL_INSERT_LSN.PG_CURRENT_WAL_LSN.PG_DATABASE_SIZE.PG_DROP_REPLICATION_SLOT.PG_EXPORT_SNAPSHOT.PG_FILENODE_RELATION.PG_GET_WAL_REPLAY_PAUSE_STATE.PG_IMPORT_SYSTEM_COLLATIONS.PG_INDEXES_SIZE.PG_IS_IN_BACKUP.PG_IS_IN_RECOVERY.PG_IS_WAL_REPLAY_PAUSED.PG_LAST_WAL_RECEIVE_LSN.PG_LAST_WAL_REPLAY_LSN.PG_LAST_XACT_REPLAY_TIMESTAMP.PG_LOGICAL_EMIT_MESSAGE.PG_LOGICAL_SLOT_GET_BINARY_CHANGES.PG_LOGICAL_SLOT_GET_CHANGES.PG_LOGICAL_SLOT_PEEK_BINARY_CHANGES.PG_LOGICAL_SLOT_PEEK_CHANGES.PG_LOG_BACKEND_MEMORY_CONTEXTS.PG_LS_ARCHIVE_STATUSDIR.PG_LS_DIR.PG_LS_LOGDIR.PG_LS_TMPDIR.PG_LS_WALDIR.PG_PARTITION_ANCESTORS.PG_PARTITION_ROOT.PG_PARTITION_TREE.PG_PROMOTE.PG_READ_BINARY_FILE.PG_READ_FILE.PG_RELATION_FILENODE.PG_RELATION_FILEPATH.PG_RELATION_SIZE.PG_RELOAD_CONF.PG_REPLICATION_ORIGIN_ADVANCE.PG_REPLICATION_ORIGIN_CREATE.PG_REPLICATION_ORIGIN_DROP.PG_REPLICATION_ORIGIN_OID.PG_REPLICATION_ORIGIN_PROGRESS.PG_REPLICATION_ORIGIN_SESSION_IS_SETUP.PG_REPLICATION_ORIGIN_SESSION_PROGRESS.PG_REPLICATION_ORIGIN_SESSION_RESET.PG_REPLICATION_ORIGIN_SESSION_SETUP.PG_REPLICATION_ORIGIN_XACT_RESET.PG_REPLICATION_ORIGIN_XACT_SETUP.PG_REPLICATION_SLOT_ADVANCE.PG_ROTATE_LOGFILE.PG_SIZE_BYTES.PG_SIZE_PRETTY.PG_START_BACKUP.PG_STAT_FILE.PG_STOP_BACKUP.PG_SWITCH_WAL.PG_TABLESPACE_SIZE.PG_TABLE_SIZE.PG_TERMINATE_BACKEND.PG_TOTAL_RELATION_SIZE.PG_TRY_ADVISORY_LOCK.PG_TRY_ADVISORY_LOCK_SHARED.PG_TRY_ADVISORY_XACT_LOCK.PG_TRY_ADVISORY_XACT_LOCK_SHARED.PG_WALFILE_NAME.PG_WALFILE_NAME_OFFSET.PG_WAL_LSN_DIFF.PG_WAL_REPLAY_PAUSE.PG_WAL_REPLAY_RESUME.SET_CONFIG.SUPPRESS_REDUNDANT_UPDATES_TRIGGER.TSVECTOR_UPDATE_TRIGGER.TSVECTOR_UPDATE_TRIGGER_COLUMN.PG_EVENT_TRIGGER_DDL_COMMANDS.PG_EVENT_TRIGGER_DROPPED_OBJECTS.PG_EVENT_TRIGGER_TABLE_REWRITE_OID.PG_EVENT_TRIGGER_TABLE_REWRITE_REASON.PG_GET_OBJECT_ADDRESS.PG_MCV_LIST_ITEMS.CAST".split("."), Un = /* @__PURE__ */ "ALL.ANALYSE.ANALYZE.AND.ANY.AS.ASC.ASYMMETRIC.AUTHORIZATION.BETWEEN.BINARY.BOTH.CASE.CAST.CHECK.COLLATE.COLLATION.COLUMN.CONCURRENTLY.CONSTRAINT.CREATE.CROSS.CURRENT_CATALOG.CURRENT_DATE.CURRENT_ROLE.CURRENT_SCHEMA.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_USER.DAY.DEFAULT.DEFERRABLE.DESC.DISTINCT.DO.ELSE.END.EXCEPT.EXISTS.FALSE.FETCH.FILTER.FOR.FOREIGN.FREEZE.FROM.FULL.GRANT.GROUP.HAVING.HOUR.ILIKE.IN.INITIALLY.INNER.INOUT.INTERSECT.INTO.IS.ISNULL.JOIN.LATERAL.LEADING.LEFT.LIKE.LIMIT.LOCALTIME.LOCALTIMESTAMP.MINUTE.MONTH.NATURAL.NOT.NOTNULL.NULL.NULLIF.OFFSET.ON.ONLY.OR.ORDER.OUT.OUTER.OVER.OVERLAPS.PLACING.PRIMARY.REFERENCES.RETURNING.RIGHT.ROW.SECOND.SELECT.SESSION_USER.SIMILAR.SOME.SYMMETRIC.TABLE.TABLESAMPLE.THEN.TO.TRAILING.TRUE.UNION.UNIQUE.USER.USING.VALUES.VARIADIC.VERBOSE.WHEN.WHERE.WINDOW.WITH.WITHIN.WITHOUT.YEAR".split("."), Wn = /* @__PURE__ */ "ARRAY.BIGINT.BIT.BIT VARYING.BOOL.BOOLEAN.CHAR.CHARACTER.CHARACTER VARYING.DECIMAL.DEC.DOUBLE.ENUM.FLOAT.INT.INTEGER.INTERVAL.NCHAR.NUMERIC.JSON.JSONB.PRECISION.REAL.SMALLINT.TEXT.TIME.TIMESTAMP.TIMESTAMPTZ.UUID.VARCHAR.XML.ZONE".split("."), Gn = S(["SELECT [ALL | DISTINCT]"]), Kn = S([
	...
	"NULLS {FIRST | LAST}",
	"WITH ORDINALITY"
]), Qn = S(["[TIMESTAMP | TIME] {WITH | WITHOUT} TIME ZONE"]), $n = {
	name: "postgresql",
	tokenizerOptions: {
		reservedSelect: Gn,
		reservedClauses: [
		...
		reservedKeywords: Un,
		reservedDataTypes: Wn,
		reservedFunctionNames: Hn,
		nestedBlockComments: !0,
		extraParens: ["[]"],
		underscoresInNumbers: !0,
		stringTypes: [
	...
	"VALUES",
	"SET"
]), ar = S(["CREATE [TEMPORARY | TEMP | LOCAL TEMPORARY | LOCAL TEMP] TABLE [IF NOT EXISTS]"]), or = S(/* @__PURE__ */ "CREATE [OR REPLACE | MATERIALIZED] VIEW.UPDATE.DELETE [FROM].DROP TABLE [IF EXISTS].ALTER TABLE.ALTER TABLE APPEND.ADD [COLUMN].DROP [COLUMN].RENAME TO.RENAME COLUMN.ALTER COLUMN.TYPE.ENCODE.TRUNCATE [TABLE].ABORT.ALTER DATABASE.ALTER DATASHARE.ALTER DEFAULT PRIVILEGES.ALTER GROUP.ALTER MATERIALIZED VIEW.ALTER PROCEDURE.ALTER SCHEMA.ALTER USER.ANALYSE.ANALYZE.ANALYSE COMPRESSION.ANALYZE COMPRESSION.BEGIN.CALL.CANCEL.CLOSE.COMMIT.COPY.CREATE DATABASE.CREATE DATASHARE.CREATE EXTERNAL FUNCTION.CREATE EXTERNAL SCHEMA.CREATE EXTERNAL TABLE.CREATE FUNCTION.CREATE GROUP.CREATE LIBRARY.CREATE MODEL.CREATE PROCEDURE.CREATE SCHEMA.CREATE USER.DEALLOCATE.DECLARE.DESC DATASHARE.DROP DATABASE.DROP DATASHARE.DROP FUNCTION.DROP GROUP.DROP LIBRARY.DROP MODEL.DROP MATERIALIZED VIEW.DROP PROCEDURE.DROP SCHEMA.DROP USER.DROP VIEW.DROP.EXECUTE.EXPLAIN.FETCH.GRANT.LOCK.PREPARE.REFRESH MATERIALIZED VIEW.RESET.REVOKE.ROLLBACK.SELECT INTO.SET SESSION AUTHORIZATION.SET SESSION CHARACTERISTICS.SHOW.SHOW EXTERNAL TABLE.SHOW MODEL.SHOW DATASHARES.SHOW PROCEDURE.SHOW TABLE.SHOW VIEW.START TRANSACTION.UNLOAD.VACUUM".split(".")), sr = S([
	"UNION [ALL]",
	"EXCEPT",
	"INTERSECT",
	"MINUS"
...
}, fr = /* @__PURE__ */ "ADD.AFTER.ALL.ALTER.ANALYZE.AND.ANTI.ANY.ARCHIVE.AS.ASC.AT.AUTHORIZATION.BETWEEN.BOTH.BUCKET.BUCKETS.BY.CACHE.CASCADE.CAST.CHANGE.CHECK.CLEAR.CLUSTER.CLUSTERED.CODEGEN.COLLATE.COLLECTION.COLUMN.COLUMNS.COMMENT.COMMIT.COMPACT.COMPACTIONS.COMPUTE.CONCATENATE.CONSTRAINT.COST.CREATE.CROSS.CUBE.CURRENT.CURRENT_DATE.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_USER.DATA.DATABASE.DATABASES.DAY.DBPROPERTIES.DEFINED.DELETE.DELIMITED.DESC.DESCRIBE.DFS.DIRECTORIES.DIRECTORY.DISTINCT.DISTRIBUTE.DIV.DROP.ESCAPE.ESCAPED.EXCEPT.EXCHANGE.EXISTS.EXPORT.EXTENDED.EXTERNAL.EXTRACT.FALSE.FETCH.FIELDS.FILTER.FILEFORMAT.FIRST.FIRST_VALUE.FOLLOWING.FOR.FOREIGN.FORMAT.FORMATTED.FULL.FUNCTION.FUNCTIONS.GLOBAL.GRANT.GROUP.GROUPING.HOUR.IF.IGNORE.IMPORT.IN.INDEX.INDEXES.INNER.INPATH.INPUTFORMAT.INTERSECT.INTO.IS.ITEMS.KEYS.LAST.LAST_VALUE.LATERAL.LAZY.LEADING.LEFT.LIKE.LINES.LIST.LOCAL.LOCATION.LOCK.LOCKS.LOGICAL.MACRO.MATCHED.MERGE.MINUTE.MONTH.MSCK.NAMESPACE.NAMESPACES.NATURAL.NO.NOT.NULL.NULLS.OF.ONLY.OPTION.OPTIONS.OR.ORDER.OUT.OUTER.OUTPUTFORMAT.OVER.OVERLAPS.OVERLAY.OVERWRITE.OWNER.PARTITION.PARTITIONED.PARTITIONS.PERCENT.PLACING.POSITION.PRECEDING.PRIMARY.PRINCIPALS.PROPERTIES.PURGE.QUERY.RANGE.RECORDREADER.RECORDWRITER.RECOVER.REDUCE.REFERENCES.RENAME.REPAIR.REPLACE.RESPECT.RESTRICT.REVOKE.RIGHT.RLIKE.ROLE.ROLES.ROLLBACK.ROLLUP.ROW.ROWS.SCHEMA.SECOND.SELECT.SEMI.SEPARATED.SERDE.SERDEPROPERTIES.SESSION_USER.SETS.SHOW.SKEWED.SOME.SORT.SORTED.START.STATISTICS.STORED.STRATIFY.SUBSTR.SUBSTRING.TABLE.TABLES.TBLPROPERTIES.TEMPORARY.TERMINATED.THEN.TO.TOUCH.TRAILING.TRANSACTION.TRANSACTIONS.TRIM.TRUE.TRUNCATE.UNARCHIVE.UNBOUNDED.UNCACHE.UNIQUE.UNKNOWN.UNLOCK.UNSET.USE.USER.USING.VIEW.WINDOW.YEAR.ANALYSE.ARRAY_ZIP.COALESCE.CONTAINS.CONVERT.DAYS.DAY_HOUR.DAY_MINUTE.DAY_SECOND.DECODE.DEFAULT.DISTINCTROW.ENCODE.EXPLODE.EXPLODE_OUTER.FIXED.GREATEST.GROUP_CONCAT.HOURS.HOUR_MINUTE.HOUR_SECOND.IFNULL.LEAST.LEVEL.MINUTE_SECOND.NULLIF.OFFSET.ON.OPTIMIZE.REGEXP.SEPARATOR.SIZE.TYPE.TYPES.UNSIGNED.VARIABLES.YEAR_MONTH".split("."), pr = /* @__PURE__ */ "ARRAY.BIGINT.BINARY.BOOLEAN.BYTE.CHAR.DATE.DEC.DECIMAL.DOUBLE.FLOAT.INT.INTEGER.INTERVAL.LONG.MAP.NUMERIC.REAL.SHORT.SMALLINT.STRING.STRUCT.TIMESTAMP_LTZ.TIMESTAMP_NTZ.TIMESTAMP.TINYINT.VARCHAR".split("."), mr = /* @__PURE__ */ "APPROX_COUNT_DISTINCT.APPROX_PERCENTILE.AVG.BIT_AND.BIT_OR.BIT_XOR.BOOL_AND.BOOL_OR.COLLECT_LIST.COLLECT_SET.CORR.COUNT.COUNT.COUNT.COUNT_IF.COUNT_MIN_SKETCH.COVAR_POP.COVAR_SAMP.EVERY.FIRST.FIRST_VALUE.GROUPING.GROUPING_ID.KURTOSIS.LAST.LAST_VALUE.MAX.MAX_BY.MEAN.MIN.MIN_BY.PERCENTILE.PERCENTILE.PERCENTILE_APPROX.SKEWNESS.STD.STDDEV.STDDEV_POP.STDDEV_SAMP.SUM.VAR_POP.VAR_SAMP.VARIANCE.CUME_DIST.DENSE_RANK.LAG.LEAD.NTH_VALUE.NTILE.PERCENT_RANK.RANK.ROW_NUMBER.ARRAY.ARRAY_CONTAINS.ARRAY_DISTINCT.ARRAY_EXCEPT.ARRAY_INTERSECT.ARRAY_JOIN.ARRAY_MAX.ARRAY_MIN.ARRAY_POSITION.ARRAY_REMOVE.ARRAY_REPEAT.ARRAY_UNION.ARRAYS_OVERLAP.ARRAYS_ZIP.FLATTEN.SEQUENCE.SHUFFLE.SLICE.SORT_ARRAY.ELEMENT_AT.ELEMENT_AT.MAP_CONCAT.MAP_ENTRIES.MAP_FROM_ARRAYS.MAP_FROM_ENTRIES.MAP_KEYS.MAP_VALUES.STR_TO_MAP.ADD_MONTHS.CURRENT_DATE.CURRENT_DATE.CURRENT_TIMESTAMP.CURRENT_TIMESTAMP.CURRENT_TIMEZONE.DATE_ADD.DATE_FORMAT.DATE_FROM_UNIX_DATE.DATE_PART.DATE_SUB.DATE_TRUNC.DATEDIFF.DAY.DAYOFMONTH.DAYOFWEEK.DAYOFYEAR.EXTRACT.FROM_UNIXTIME.FROM_UTC_TIMESTAMP.HOUR.LAST_DAY.MAKE_DATE.MAKE_DT_INTERVAL.MAKE_INTERVAL.MAKE_TIMESTAMP.MAKE_YM_INTERVAL.MINUTE.MONTH.MONTHS_BETWEEN.NEXT_DAY.NOW.QUARTER.SECOND.SESSION_WINDOW.TIMESTAMP_MICROS.TIMESTAMP_MILLIS.TIMESTAMP_SECONDS.TO_DATE.TO_TIMESTAMP.TO_UNIX_TIMESTAMP.TO_UTC_TIMESTAMP.TRUNC.UNIX_DATE.UNIX_MICROS.UNIX_MILLIS.UNIX_SECONDS.UNIX_TIMESTAMP.WEEKDAY.WEEKOFYEAR.WINDOW.YEAR.FROM_JSON.GET_JSON_OBJECT.JSON_ARRAY_LENGTH.JSON_OBJECT_KEYS.JSON_TUPLE.SCHEMA_OF_JSON.TO_JSON.ABS.ACOS.ACOSH.AGGREGATE.ARRAY_SORT.ASCII.ASIN.ASINH.ASSERT_TRUE.ATAN.ATAN2.ATANH.BASE64.BIN.BIT_COUNT.BIT_GET.BIT_LENGTH.BROUND.BTRIM.CARDINALITY.CBRT.CEIL.CEILING.CHAR_LENGTH.CHARACTER_LENGTH.CHR.CONCAT.CONCAT_WS.CONV.COS.COSH.COT.CRC32.CURRENT_CATALOG.CURRENT_DATABASE.CURRENT_USER.DEGREES.ELT.EXP.EXPM1.FACTORIAL.FIND_IN_SET.FLOOR.FORALL.FORMAT_NUMBER.FORMAT_STRING.FROM_CSV.GETBIT.HASH.HEX.HYPOT.INITCAP.INLINE.INLINE_OUTER.INPUT_FILE_BLOCK_LENGTH.INPUT_FILE_BLOCK_START.INPUT_FILE_NAME.INSTR.ISNAN.ISNOTNULL.ISNULL.JAVA_METHOD.LCASE.LEFT.LENGTH.LEVENSHTEIN.LN.LOCATE.LOG.LOG10.LOG1P.LOG2.LOWER.LPAD.LTRIM.MAP_FILTER.MAP_ZIP_WITH.MD5.MOD.MONOTONICALLY_INCREASING_ID.NAMED_STRUCT.NANVL.NEGATIVE.NVL.NVL2.OCTET_LENGTH.OVERLAY.PARSE_URL.PI.PMOD.POSEXPLODE.POSEXPLODE_OUTER.POSITION.POSITIVE.POW.POWER.PRINTF.RADIANS.RAISE_ERROR.RAND.RANDN.RANDOM.REFLECT.REGEXP_EXTRACT.REGEXP_EXTRACT_ALL.REGEXP_LIKE.REGEXP_REPLACE.REPEAT.REPLACE.REVERSE.RIGHT.RINT.ROUND.RPAD.RTRIM.SCHEMA_OF_CSV.SENTENCES.SHA.SHA1.SHA2.SHIFTLEFT.SHIFTRIGHT.SHIFTRIGHTUNSIGNED.SIGN.SIGNUM.SIN.SINH.SOUNDEX.SPACE.SPARK_PARTITION_ID.SPLIT.SQRT.STACK.SUBSTR.SUBSTRING.SUBSTRING_INDEX.TAN.TANH.TO_CSV.TRANSFORM_KEYS.TRANSFORM_VALUES.TRANSLATE.TRIM.TRY_ADD.TRY_DIVIDE.TYPEOF.UCASE.UNBASE64.UNHEX.UPPER.UUID.VERSION.WIDTH_BUCKET.XPATH.XPATH_BOOLEAN.XPATH_DOUBLE.XPATH_FLOAT.XPATH_INT.XPATH_LONG.XPATH_NUMBER.XPATH_SHORT.XPATH_STRING.XXHASH64.ZIP_WITH.CAST.COALESCE.NULLIF".split("."), hr = S(["SELECT [ALL | DISTINCT]"]), gr = S([
	"WITH",
	"FROM",
	"WHERE",
	"GROUP BY",
	...
	"LOAD DATA [LOCAL] INPATH",
	"[OVERWRITE] INTO TABLE"
]), _r = S(["CREATE [EXTERNAL] TABLE [IF NOT EXISTS]"]), vr = S(/* @__PURE__ */ "CREATE [OR REPLACE] [GLOBAL TEMPORARY | TEMPORARY] VIEW [IF NOT EXISTS].DROP TABLE [IF EXISTS].ALTER TABLE.ADD COLUMNS.DROP {COLUMN | COLUMNS}.RENAME TO.RENAME COLUMN.ALTER COLUMN.TRUNCATE TABLE.LATERAL VIEW.ALTER DATABASE.ALTER VIEW.CREATE DATABASE.CREATE FUNCTION.DROP DATABASE.DROP FUNCTION.DROP VIEW.REPAIR TABLE.USE DATABASE.TABLESAMPLE.PIVOT.TRANSFORM.EXPLAIN.ADD FILE.ADD JAR.ANALYZE TABLE.CACHE TABLE.CLEAR CACHE.DESCRIBE DATABASE.DESCRIBE FUNCTION.DESCRIBE QUERY.DESCRIBE TABLE.LIST FILE.LIST JAR.REFRESH.REFRESH TABLE.REFRESH FUNCTION.RESET.SHOW COLUMNS.SHOW CREATE TABLE.SHOW DATABASES.SHOW FUNCTIONS.SHOW PARTITIONS.SHOW TABLE EXTENDED.SHOW TABLES.SHOW TBLPROPERTIES.SHOW VIEWS.UNCACHE TABLE".split(".")), yr = S([
	"UNION [ALL | DISTINCT]",
	"EXCEPT [ALL | DISTINCT]",
	"INTERSECT [ALL | DISTINCT]"
]), br = S([
...
function wr(e) {
	return e.map((t, n) => {
		let r = e[n - 1] || A, i = e[n + 1] || A;
		return M.WINDOW(t) && i.type === O.OPEN_PAREN ? Object.assign(Object.assign({}, t), { type: O.RESERVED_FUNCTION_NAME }) : t.text === "ITEMS" && t.type === O.RESERVED_KEYWORD && (r.text !== "COLLECTION" || i.text !== "TERMINATED") ? Object.assign(Object.assign({}, t), {
			type: O.IDENTIFIER,
			text: t.raw
		}) : t;
	});
...
var Tr = /* @__PURE__ */ "ABS.CHANGES.CHAR.COALESCE.FORMAT.GLOB.HEX.IFNULL.IIF.INSTR.LAST_INSERT_ROWID.LENGTH.LIKE.LIKELIHOOD.LIKELY.LOAD_EXTENSION.LOWER.LTRIM.NULLIF.PRINTF.QUOTE.RANDOM.RANDOMBLOB.REPLACE.ROUND.RTRIM.SIGN.SOUNDEX.SQLITE_COMPILEOPTION_GET.SQLITE_COMPILEOPTION_USED.SQLITE_OFFSET.SQLITE_SOURCE_ID.SQLITE_VERSION.SUBSTR.SUBSTRING.TOTAL_CHANGES.TRIM.TYPEOF.UNICODE.UNLIKELY.UPPER.ZEROBLOB.AVG.COUNT.GROUP_CONCAT.MAX.MIN.SUM.TOTAL.DATE.TIME.DATETIME.JULIANDAY.UNIXEPOCH.STRFTIME.row_number.rank.dense_rank.percent_rank.cume_dist.ntile.lag.lead.first_value.last_value.nth_value.ACOS.ACOSH.ASIN.ASINH.ATAN.ATAN2.ATANH.CEIL.CEILING.COS.COSH.DEGREES.EXP.FLOOR.LN.LOG.LOG.LOG10.LOG2.MOD.PI.POW.POWER.RADIANS.SIN.SINH.SQRT.TAN.TANH.TRUNC.JSON.JSON_ARRAY.JSON_ARRAY_LENGTH.JSON_ARRAY_LENGTH.JSON_EXTRACT.JSON_INSERT.JSON_OBJECT.JSON_PATCH.JSON_REMOVE.JSON_REPLACE.JSON_SET.JSON_TYPE.JSON_TYPE.JSON_VALID.JSON_QUOTE.JSON_GROUP_ARRAY.JSON_GROUP_OBJECT.JSON_EACH.JSON_TREE.CAST".split("."), Er = /* @__PURE__ */ "ABORT.ACTION.ADD.AFTER.ALL.ALTER.AND.ARE.ALWAYS.ANALYZE.AS.ASC.ATTACH.AUTOINCREMENT.BEFORE.BEGIN.BETWEEN.BY.CASCADE.CASE.CAST.CHECK.COLLATE.COLUMN.COMMIT.CONFLICT.CONSTRAINT.CREATE.CROSS.CURRENT.CURRENT_DATE.CURRENT_TIME.CURRENT_TIMESTAMP.DATABASE.DEFAULT.DEFERRABLE.DEFERRED.DELETE.DESC.DETACH.DISTINCT.DO.DROP.EACH.ELSE.END.ESCAPE.EXCEPT.EXCLUDE.EXCLUSIVE.EXISTS.EXPLAIN.FAIL.FILTER.FIRST.FOLLOWING.FOR.FOREIGN.FROM.FULL.GENERATED.GLOB.GROUP.HAVING.IF.IGNORE.IMMEDIATE.IN.INDEX.INDEXED.INITIALLY.INNER.INSERT.INSTEAD.INTERSECT.INTO.IS.ISNULL.JOIN.KEY.LAST.LEFT.LIKE.LIMIT.MATCH.MATERIALIZED.NATURAL.NO.NOT.NOTHING.NOTNULL.NULL.NULLS.OF.OFFSET.ON.ONLY.OPEN.OR.ORDER.OTHERS.OUTER.OVER.PARTITION.PLAN.PRAGMA.PRECEDING.PRIMARY.QUERY.RAISE.RANGE.RECURSIVE.REFERENCES.REGEXP.REINDEX.RELEASE.RENAME.REPLACE.RESTRICT.RETURNING.RIGHT.ROLLBACK.ROW.ROWS.SAVEPOINT.SELECT.SET.TABLE.TEMP.TEMPORARY.THEN.TIES.TO.TRANSACTION.TRIGGER.UNBOUNDED.UNION.UNIQUE.UPDATE.USING.VACUUM.VALUES.VIEW.VIRTUAL.WHEN.WHERE.WINDOW.WITH.WITHOUT".split("."), Dr = [
	...
	"SET",
	"RETURNING"
]), Ar = S(["CREATE [TEMPORARY | TEMP] TABLE [IF NOT EXISTS]"]), jr = S([
	...
	formatOptions: {
		onelineClauses: [...Ar, ...jr],
		tabularOnelineClauses: jr
	}
}, Lr = /* @__PURE__ */ "GROUPING.RANK.DENSE_RANK.PERCENT_RANK.CUME_DIST.ROW_NUMBER.POSITION.OCCURRENCES_REGEX.POSITION_REGEX.EXTRACT.CHAR_LENGTH.CHARACTER_LENGTH.OCTET_LENGTH.CARDINALITY.ABS.MOD.LN.EXP.POWER.SQRT.FLOOR.CEIL.CEILING.WIDTH_BUCKET.SUBSTRING.SUBSTRING_REGEX.UPPER.LOWER.CONVERT.TRANSLATE.TRANSLATE_REGEX.TRIM.OVERLAY.NORMALIZE.SPECIFICTYPE.CURRENT_DATE.CURRENT_TIME.LOCALTIME.CURRENT_TIMESTAMP.LOCALTIMESTAMP.COUNT.AVG.MAX.MIN.SUM.STDDEV_POP.STDDEV_SAMP.VAR_SAMP.VAR_POP.COLLECT.FUSION.INTERSECTION.COVAR_POP.COVAR_SAMP.CORR.REGR_SLOPE.REGR_INTERCEPT.REGR_COUNT.REGR_R2.REGR_AVGX.REGR_AVGY.REGR_SXX.REGR_SYY.REGR_SXY.PERCENTILE_CONT.PERCENTILE_DISC.CAST.COALESCE.NULLIF.ROUND.SIN.COS.TAN.ASIN.ACOS.ATAN".split("."), Rr = /* @__PURE__ */ "ALL.ALLOCATE.ALTER.ANY.ARE.AS.ASC.ASENSITIVE.ASYMMETRIC.AT.ATOMIC.AUTHORIZATION.BEGIN.BETWEEN.BOTH.BY.CALL.CALLED.CASCADED.CAST.CHECK.CLOSE.COALESCE.COLLATE.COLUMN.COMMIT.CONDITION.CONNECT.CONSTRAINT.CORRESPONDING.CREATE.CROSS.CUBE.CURRENT.CURRENT_CATALOG.CURRENT_DEFAULT_TRANSFORM_GROUP.CURRENT_PATH.CURRENT_ROLE.CURRENT_SCHEMA.CURRENT_TRANSFORM_GROUP_FOR_TYPE.CURRENT_USER.CURSOR.CYCLE.DEALLOCATE.DAY.DECLARE.DEFAULT.DELETE.DEREF.DESC.DESCRIBE.DETERMINISTIC.DISCONNECT.DISTINCT.DROP.DYNAMIC.EACH.ELEMENT.END-EXEC.ESCAPE.EVERY.EXCEPT.EXEC.EXECUTE.EXISTS.EXTERNAL.FALSE.FETCH.FILTER.FOR.FOREIGN.FREE.FROM.FULL.FUNCTION.GET.GLOBAL.GRANT.GROUP.HAVING.HOLD.HOUR.IDENTITY.IN.INDICATOR.INNER.INOUT.INSENSITIVE.INSERT.INTERSECT.INTO.IS.LANGUAGE.LARGE.LATERAL.LEADING.LEFT.LIKE.LIKE_REGEX.LOCAL.MATCH.MEMBER.MERGE.METHOD.MINUTE.MODIFIES.MODULE.MONTH.NATURAL.NEW.NO.NONE.NOT.NULL.NULLIF.OF.OLD.ON.ONLY.OPEN.ORDER.OUT.OUTER.OVER.OVERLAPS.PARAMETER.PARTITION.PRECISION.PREPARE.PRIMARY.PROCEDURE.RANGE.READS.REAL.RECURSIVE.REF.REFERENCES.REFERENCING.RELEASE.RESULT.RETURN.RETURNS.REVOKE.RIGHT.ROLLBACK.ROLLUP.ROW.ROWS.SAVEPOINT.SCOPE.SCROLL.SEARCH.SECOND.SELECT.SENSITIVE.SESSION_USER.SET.SIMILAR.SOME.SPECIFIC.SQL.SQLEXCEPTION.SQLSTATE.SQLWARNING.START.STATIC.SUBMULTISET.SYMMETRIC.SYSTEM.SYSTEM_USER.TABLE.TABLESAMPLE.THEN.TIMEZONE_HOUR.TIMEZONE_MINUTE.TO.TRAILING.TRANSLATION.TREAT.TRIGGER.TRUE.UESCAPE.UNION.UNIQUE.UNKNOWN.UNNEST.UPDATE.USER.USING.VALUE.VALUES.WHENEVER.WINDOW.WITHIN.WITHOUT.YEAR".split("."), zr = /* @__PURE__ */ "ARRAY.BIGINT.BINARY LARGE OBJECT.BINARY VARYING.BINARY.BLOB.BOOLEAN.CHAR LARGE OBJECT.CHAR VARYING.CHAR.CHARACTER LARGE OBJECT.CHARACTER VARYING.CHARACTER.CLOB.DATE.DEC.DECIMAL.DOUBLE.FLOAT.INT.INTEGER.INTERVAL.MULTISET.NATIONAL CHAR VARYING.NATIONAL CHAR.NATIONAL CHARACTER LARGE OBJECT.NATIONAL CHARACTER VARYING.NATIONAL CHARACTER.NCHAR LARGE OBJECT.NCHAR VARYING.NCHAR.NCLOB.NUMERIC.SMALLINT.TIME.TIMESTAMP.VARBINARY.VARCHAR".split("."), Br = S(["SELECT [ALL | DISTINCT]"]), Vr = S([
	"WITH [RECURSIVE]",
	"FROM",
	"WHERE",
	"GROUP BY [ALL | DISTINCT]",
	...
	"VALUES",
	"SET"
]), Hr = S(["CREATE [GLOBAL TEMPORARY | LOCAL TEMPORARY] TABLE"]), Ur = S([
	...
	"NATURAL [INNER] JOIN",
	"NATURAL {LEFT | RIGHT | FULL} [OUTER] JOIN"
]), Kr = S(["ON {UPDATE | DELETE} [SET NULL | SET DEFAULT]", "{ROWS | RANGE} BETWEEN"]), qr = S([]), Jr = {
	name: "sql",
	tokenizerOptions: {
		reservedSelect: Br,
		reservedClauses: [
	...
	"SUBSET",
	"DEFINE"
]), ei = S(["CREATE TABLE [IF NOT EXISTS]"]), ti = S(/* @__PURE__ */ "CREATE [OR REPLACE] [MATERIALIZED] VIEW.UPDATE.DELETE FROM.DROP TABLE [IF EXISTS].ALTER TABLE [IF EXISTS].ADD COLUMN [IF NOT EXISTS].DROP COLUMN [IF EXISTS].RENAME COLUMN [IF EXISTS].RENAME TO.SET AUTHORIZATION [USER | ROLE].SET PROPERTIES.EXECUTE.TRUNCATE TABLE.ALTER SCHEMA.ALTER MATERIALIZED VIEW.ALTER VIEW.CREATE SCHEMA.CREATE ROLE.DROP SCHEMA.DROP MATERIALIZED VIEW.DROP VIEW.DROP ROLE.EXPLAIN.ANALYZE.EXPLAIN ANALYZE.EXPLAIN ANALYZE VERBOSE.USE.DESCRIBE INPUT.DESCRIBE OUTPUT.REFRESH MATERIALIZED VIEW.RESET SESSION.SET SESSION.SET PATH.SET TIME ZONE.SHOW GRANTS.SHOW CREATE TABLE.SHOW CREATE SCHEMA.SHOW CREATE VIEW.SHOW CREATE MATERIALIZED VIEW.SHOW TABLES.SHOW SCHEMAS.SHOW CATALOGS.SHOW COLUMNS.SHOW STATS FOR.SHOW ROLES.SHOW CURRENT ROLES.SHOW ROLE GRANTS.SHOW FUNCTIONS.SHOW SESSION".split(".")), ni = S([
	...
	"{INNER | CROSS} JOIN",
	"{CROSS | OUTER} APPLY"
]), gi = S(["ON {UPDATE | DELETE} [SET NULL | SET DEFAULT]", "{ROWS | RANGE} BETWEEN"]), _i = S([]), vi = {
	name: "transactsql",
	tokenizerOptions: {
		reservedSelect: ui,
		reservedClauses: [
	...
	formatOptions: {
		alwaysDenseOperators: ["::"],
		onelineClauses: [...fi, ...pi],
		tabularOnelineClauses: pi
	}
}, yi = /* @__PURE__ */ "ADD.ALL.ALTER.ANALYZE.AND.AS.ASC.ASENSITIVE.BEFORE.BETWEEN._BINARY.BOTH.BY.CALL.CASCADE.CASE.CHANGE.CHECK.COLLATE.COLUMN.CONDITION.CONSTRAINT.CONTINUE.CONVERT.CREATE.CROSS.CURRENT_DATE.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_USER.CURSOR.DATABASE.DATABASES.DAY_HOUR.DAY_MICROSECOND.DAY_MINUTE.DAY_SECOND.DECLARE.DEFAULT.DELAYED.DELETE.DESC.DESCRIBE.DETERMINISTIC.DISTINCT.DISTINCTROW.DIV.DROP.DUAL.EACH.ELSE.ELSEIF.ENCLOSED.ESCAPED.EXCEPT.EXISTS.EXIT.EXPLAIN.EXTRA_JOIN.FALSE.FETCH.FOR.FORCE.FORCE_COMPILED_MODE.FORCE_INTERPRETER_MODE.FOREIGN.FROM.FULL.FULLTEXT.GRANT.GROUP.HAVING.HEARTBEAT_NO_LOGGING.HIGH_PRIORITY.HOUR_MICROSECOND.HOUR_MINUTE.HOUR_SECOND.IF.IGNORE.IN.INDEX.INFILE.INNER.INOUT.INSENSITIVE.INSERT.IN._INTERNAL_DYNAMIC_TYPECAST.INTERSECT.INTERVAL.INTO.ITERATE.JOIN.KEY.KEYS.KILL.LEADING.LEAVE.LEFT.LIKE.LIMIT.LINES.LOAD.LOCALTIME.LOCALTIMESTAMP.LOCK.LOOP.LOW_PRIORITY.MATCH.MAXVALUE.MINUS.MINUTE_MICROSECOND.MINUTE_SECOND.MOD.MODIFIES.NATURAL.NO_QUERY_REWRITE.NOT.NO_WRITE_TO_BINLOG.NO_QUERY_REWRITE.NULL.ON.OPTIMIZE.OPTION.OPTIONALLY.OR.ORDER.OUT.OUTER.OUTFILE.OVER.PRIMARY.PROCEDURE.PURGE.RANGE.READ.READS.REFERENCES.REGEXP.RELEASE.RENAME.REPEAT.REPLACE.REQUIRE.RESTRICT.RETURN.REVOKE.RIGHT.RIGHT_ANTI_JOIN.RIGHT_SEMI_JOIN.RIGHT_STRAIGHT_JOIN.RLIKE.SCHEMA.SCHEMAS.SECOND_MICROSECOND.SELECT.SEMI_JOIN.SENSITIVE.SEPARATOR.SET.SHOW.SIGNAL.SPATIAL.SPECIFIC.SQL.SQL_BIG_RESULT.SQL_BUFFER_RESULT.SQL_CACHE.SQL_CALC_FOUND_ROWS.SQLEXCEPTION.SQL_NO_CACHE.SQL_NO_LOGGING.SQL_SMALL_RESULT.SQLSTATE.SQLWARNING.STRAIGHT_JOIN.TABLE.TERMINATED.THEN.TO.TRAILING.TRIGGER.TRUE.UNBOUNDED.UNDO.UNION.UNIQUE.UNLOCK.UPDATE.USAGE.USE.USING.UTC_DATE.UTC_TIME.UTC_TIMESTAMP._UTF8.VALUES.WHEN.WHERE.WHILE.WINDOW.WITH.WITHIN.WRITE.XOR.YEAR_MONTH.ZEROFILL".split("."), bi = /* @__PURE__ */ "BIGINT.BINARY.BIT.BLOB.CHAR.CHARACTER.DATETIME.DEC.DECIMAL.DOUBLE PRECISION.DOUBLE.ENUM.FIXED.FLOAT.FLOAT4.FLOAT8.INT.INT1.INT2.INT3.INT4.INT8.INTEGER.LONG.LONGBLOB.LONGTEXT.MEDIUMBLOB.MEDIUMINT.MEDIUMTEXT.MIDDLEINT.NATIONAL CHAR.NATIONAL VARCHAR.NUMERIC.PRECISION.REAL.SMALLINT.TEXT.TIME.TIMESTAMP.TINYBLOB.TINYINT.TINYTEXT.UNSIGNED.VARBINARY.VARCHAR.VARCHARACTER.YEAR".split("."), xi = /* @__PURE__ */ "ABS.ACOS.ADDDATE.ADDTIME.AES_DECRYPT.AES_ENCRYPT.ANY_VALUE.APPROX_COUNT_DISTINCT.APPROX_COUNT_DISTINCT_ACCUMULATE.APPROX_COUNT_DISTINCT_COMBINE.APPROX_COUNT_DISTINCT_ESTIMATE.APPROX_GEOGRAPHY_INTERSECTS.APPROX_PERCENTILE.ASCII.ASIN.ATAN.ATAN2.AVG.BIN.BINARY.BIT_AND.BIT_COUNT.BIT_OR.BIT_XOR.CAST.CEIL.CEILING.CHAR.CHARACTER_LENGTH.CHAR_LENGTH.CHARSET.COALESCE.COERCIBILITY.COLLATION.COLLECT.CONCAT.CONCAT_WS.CONNECTION_ID.CONV.CONVERT.CONVERT_TZ.COS.COT.COUNT.CUME_DIST.CURDATE.CURRENT_DATE.CURRENT_ROLE.CURRENT_TIME.CURRENT_TIMESTAMP.CURRENT_USER.CURTIME.DATABASE.DATE.DATE_ADD.DATEDIFF.DATE_FORMAT.DATE_SUB.DATE_TRUNC.DAY.DAYNAME.DAYOFMONTH.DAYOFWEEK.DAYOFYEAR.DECODE.DEFAULT.DEGREES.DENSE_RANK.DIV.DOT_PRODUCT.ELT.EUCLIDEAN_DISTANCE.EXP.EXTRACT.FIELD.FIRST.FIRST_VALUE.FLOOR.FORMAT.FOUND_ROWS.FROM_BASE64.FROM_DAYS.FROM_UNIXTIME.GEOGRAPHY_AREA.GEOGRAPHY_CONTAINS.GEOGRAPHY_DISTANCE.GEOGRAPHY_INTERSECTS.GEOGRAPHY_LATITUDE.GEOGRAPHY_LENGTH.GEOGRAPHY_LONGITUDE.GEOGRAPHY_POINT.GEOGRAPHY_WITHIN_DISTANCE.GEOMETRY_AREA.GEOMETRY_CONTAINS.GEOMETRY_DISTANCE.GEOMETRY_FILTER.GEOMETRY_INTERSECTS.GEOMETRY_LENGTH.GEOMETRY_POINT.GEOMETRY_WITHIN_DISTANCE.GEOMETRY_X.GEOMETRY_Y.GREATEST.GROUPING.GROUP_CONCAT.HEX.HIGHLIGHT.HOUR.ICU_VERSION.IF.IFNULL.INET_ATON.INET_NTOA.INET6_ATON.INET6_NTOA.INITCAP.INSERT.INSTR.INTERVAL.IS.IS NULL.JSON_AGG.JSON_ARRAY_CONTAINS_DOUBLE.JSON_ARRAY_CONTAINS_JSON.JSON_ARRAY_CONTAINS_STRING.JSON_ARRAY_PUSH_DOUBLE.JSON_ARRAY_PUSH_JSON.JSON_ARRAY_PUSH_STRING.JSON_DELETE_KEY.JSON_EXTRACT_DOUBLE.JSON_EXTRACT_JSON.JSON_EXTRACT_STRING.JSON_EXTRACT_BIGINT.JSON_GET_TYPE.JSON_LENGTH.JSON_SET_DOUBLE.JSON_SET_JSON.JSON_SET_STRING.JSON_SPLICE_DOUBLE.JSON_SPLICE_JSON.JSON_SPLICE_STRING.LAG.LAST_DAY.LAST_VALUE.LCASE.LEAD.LEAST.LEFT.LENGTH.LIKE.LN.LOCALTIME.LOCALTIMESTAMP.LOCATE.LOG.LOG10.LOG2.LPAD.LTRIM.MATCH.MAX.MD5.MEDIAN.MICROSECOND.MIN.MINUTE.MOD.MONTH.MONTHNAME.MONTHS_BETWEEN.NOT.NOW.NTH_VALUE.NTILE.NULLIF.OCTET_LENGTH.PERCENT_RANK.PERCENTILE_CONT.PERCENTILE_DISC.PI.PIVOT.POSITION.POW.POWER.QUARTER.QUOTE.RADIANS.RAND.RANK.REGEXP.REPEAT.REPLACE.REVERSE.RIGHT.RLIKE.ROUND.ROW_COUNT.ROW_NUMBER.RPAD.RTRIM.SCALAR.SCHEMA.SEC_TO_TIME.SHA1.SHA2.SIGMOID.SIGN.SIN.SLEEP.SPLIT.SOUNDEX.SOUNDS LIKE.SOURCE_POS_WAIT.SPACE.SQRT.STDDEV.STDDEV_POP.STDDEV_SAMP.STR_TO_DATE.SUBDATE.SUBSTR.SUBSTRING.SUBSTRING_INDEX.SUM.SYS_GUID.TAN.TIME.TIMEDIFF.TIME_BUCKET.TIME_FORMAT.TIMESTAMP.TIMESTAMPADD.TIMESTAMPDIFF.TIME_TO_SEC.TO_BASE64.TO_CHAR.TO_DAYS.TO_JSON.TO_NUMBER.TO_SECONDS.TO_TIMESTAMP.TRIM.TRUNC.TRUNCATE.UCASE.UNHEX.UNIX_TIMESTAMP.UPDATEXML.UPPER.UTC_DATE.UTC_TIME.UTC_TIMESTAMP.UUID.VALUES.VARIANCE.VAR_POP.VAR_SAMP.VECTOR_SUB.VERSION.WEEK.WEEKDAY.WEEKOFYEAR.YEAR".split("."), Si = S(["SELECT [ALL | DISTINCT | DISTINCTROW]"]), Ci = S([
	"WITH",
	"FROM",
	"WHERE",
	"GROUP BY",
...
]), Ii = S(["CREATE [OR REPLACE] [VOLATILE] TABLE [IF NOT EXISTS]", "CREATE [OR REPLACE] [LOCAL | GLOBAL] {TEMP|TEMPORARY} TABLE [IF NOT EXISTS]"]), F = S(/* @__PURE__ */ "CREATE [OR REPLACE] [SECURE] [RECURSIVE] VIEW [IF NOT EXISTS].UPDATE.DELETE FROM.DROP TABLE [IF EXISTS].ALTER TABLE [IF EXISTS].RENAME TO.SWAP WITH.[SUSPEND | RESUME] RECLUSTER.DROP CLUSTERING KEY.ADD [COLUMN].RENAME COLUMN.{ALTER | MODIFY} [COLUMN].DROP [COLUMN].{ADD | ALTER | MODIFY | DROP} [CONSTRAINT].RENAME CONSTRAINT.{ADD | DROP} SEARCH OPTIMIZATION.{SET | UNSET} TAG.{ADD | DROP} ROW ACCESS POLICY.DROP ALL ROW ACCESS POLICIES.{SET | DROP} DEFAULT.{SET | DROP} NOT NULL.SET DATA TYPE.UNSET COMMENT.{SET | UNSET} MASKING POLICY.TRUNCATE [TABLE] [IF EXISTS].ALTER ACCOUNT.ALTER API INTEGRATION.ALTER CONNECTION.ALTER DATABASE.ALTER EXTERNAL TABLE.ALTER FAILOVER GROUP.ALTER FILE FORMAT.ALTER FUNCTION.ALTER INTEGRATION.ALTER MASKING POLICY.ALTER MATERIALIZED VIEW.ALTER NETWORK POLICY.ALTER NOTIFICATION INTEGRATION.ALTER PIPE.ALTER PROCEDURE.ALTER REPLICATION GROUP.ALTER RESOURCE MONITOR.ALTER ROLE.ALTER ROW ACCESS POLICY.ALTER SCHEMA.ALTER SECURITY INTEGRATION.ALTER SEQUENCE.ALTER SESSION.ALTER SESSION POLICY.ALTER SHARE.ALTER STAGE.ALTER STORAGE INTEGRATION.ALTER STREAM.ALTER TAG.ALTER TASK.ALTER USER.ALTER VIEW.ALTER WAREHOUSE.BEGIN.CALL.COMMIT.COPY INTO.CREATE ACCOUNT.CREATE API INTEGRATION.CREATE CONNECTION.CREATE DATABASE.CREATE EXTERNAL FUNCTION.CREATE EXTERNAL TABLE.CREATE FAILOVER GROUP.CREATE FILE FORMAT.CREATE FUNCTION.CREATE INTEGRATION.CREATE MANAGED ACCOUNT.CREATE MASKING POLICY.CREATE MATERIALIZED VIEW.CREATE NETWORK POLICY.CREATE NOTIFICATION INTEGRATION.CREATE PIPE.CREATE PROCEDURE.CREATE REPLICATION GROUP.CREATE RESOURCE MONITOR.CREATE ROLE.CREATE ROW ACCESS POLICY.CREATE SCHEMA.CREATE SECURITY INTEGRATION.CREATE SEQUENCE.CREATE SESSION POLICY.CREATE SHARE.CREATE STAGE.CREATE STORAGE INTEGRATION.CREATE STREAM.CREATE TAG.CREATE TASK.CREATE USER.CREATE WAREHOUSE.DELETE.DESCRIBE DATABASE.DESCRIBE EXTERNAL TABLE.DESCRIBE FILE FORMAT.DESCRIBE FUNCTION.DESCRIBE INTEGRATION.DESCRIBE MASKING POLICY.DESCRIBE MATERIALIZED VIEW.DESCRIBE NETWORK POLICY.DESCRIBE PIPE.DESCRIBE PROCEDURE.DESCRIBE RESULT.DESCRIBE ROW ACCESS POLICY.DESCRIBE SCHEMA.DESCRIBE SEQUENCE.DESCRIBE SESSION POLICY.DESCRIBE SHARE.DESCRIBE STAGE.DESCRIBE STREAM.DESCRIBE TABLE.DESCRIBE TASK.DESCRIBE TRANSACTION.DESCRIBE USER.DESCRIBE VIEW.DESCRIBE WAREHOUSE.DROP CONNECTION.DROP DATABASE.DROP EXTERNAL TABLE.DROP FAILOVER GROUP.DROP FILE FORMAT.DROP FUNCTION.DROP INTEGRATION.DROP MANAGED ACCOUNT.DROP MASKING POLICY.DROP MATERIALIZED VIEW.DROP NETWORK POLICY.DROP PIPE.DROP PROCEDURE.DROP REPLICATION GROUP.DROP RESOURCE MONITOR.DROP ROLE.DROP ROW ACCESS POLICY.DROP SCHEMA.DROP SEQUENCE.DROP SESSION POLICY.DROP SHARE.DROP STAGE.DROP STREAM.DROP TAG.DROP TASK.DROP USER.DROP VIEW.DROP WAREHOUSE.EXECUTE IMMEDIATE.EXECUTE TASK.EXPLAIN.GET.GRANT OWNERSHIP.GRANT ROLE.INSERT.LIST.MERGE.PUT.REMOVE.REVOKE ROLE.ROLLBACK.SHOW COLUMNS.SHOW CONNECTIONS.SHOW DATABASES.SHOW DATABASES IN FAILOVER GROUP.SHOW DATABASES IN REPLICATION GROUP.SHOW DELEGATED AUTHORIZATIONS.SHOW EXTERNAL FUNCTIONS.SHOW EXTERNAL TABLES.SHOW FAILOVER GROUPS.SHOW FILE FORMATS.SHOW FUNCTIONS.SHOW GLOBAL ACCOUNTS.SHOW GRANTS.SHOW INTEGRATIONS.SHOW LOCKS.SHOW MANAGED ACCOUNTS.SHOW MASKING POLICIES.SHOW MATERIALIZED VIEWS.SHOW NETWORK POLICIES.SHOW OBJECTS.SHOW ORGANIZATION ACCOUNTS.SHOW PARAMETERS.SHOW PIPES.SHOW PRIMARY KEYS.SHOW PROCEDURES.SHOW REGIONS.SHOW REPLICATION ACCOUNTS.SHOW REPLICATION DATABASES.SHOW REPLICATION GROUPS.SHOW RESOURCE MONITORS.SHOW ROLES.SHOW ROW ACCESS POLICIES.SHOW SCHEMAS.SHOW SEQUENCES.SHOW SESSION POLICIES.SHOW SHARES.SHOW SHARES IN FAILOVER GROUP.SHOW SHARES IN REPLICATION GROUP.SHOW STAGES.SHOW STREAMS.SHOW TABLES.SHOW TAGS.SHOW TASKS.SHOW TRANSACTIONS.SHOW USER FUNCTIONS.SHOW USERS.SHOW VARIABLES.SHOW VIEWS.SHOW WAREHOUSES.TRUNCATE MATERIALIZED VIEW.UNDROP DATABASE.UNDROP SCHEMA.UNDROP TABLE.UNDROP TAG.UNSET.USE DATABASE.USE ROLE.USE SCHEMA.USE SECONDARY ROLES.USE WAREHOUSE".split(".")), Li = S([
	"UNION [ALL]",
	"MINUS",
	"EXCEPT",
	"INTERSECT"
	...
	"[NATURAL] {LEFT | RIGHT | FULL} [OUTER] JOIN",
	"{CROSS | NATURAL} JOIN"
]), zi = S(["{ROWS | RANGE} BETWEEN", "ON {UPDATE | DELETE} [SET NULL | SET DEFAULT]"]), Bi = S([]), Vi = {
	name: "snowflake",
	tokenizerOptions: {
		reservedSelect: Pi,
		reservedClauses: [
	...
	transactsql: () => vi,
	trino: () => oi
}), I = (e) => e[e.length - 1], Ui = (e) => e.sort((e, t) => t.length - e.length || e.localeCompare(t)), L = (e) => e.replace(/\s+/gu, " "), Wi = (e) => /\n/.test(e), R = (e) => e.replace(/[.*+?^${}()|[\]\\]/gu, "\\$&"), Gi = /\s+/uy, z = (e) => RegExp(`(?:${e})`, "uy"), Ki = (e) => e.split("").map((e) => / /gu.test(e) ? "\\s+" : `[${e.toUpperCase()}${e.toLowerCase()}]`).join(""), qi = (e) => e + "(?:-" + e + ")*", Ji = ({ prefixes: e, requirePrefix: t }) => `(?:${e.map(Ki).join("|")}${t ? "" : "|"})`, Yi = (e) => RegExp(`(?:${e.map(R).join("|")}).*?(?=\r\n|\r|\n|$)`, "uy"), Xi = (e, t = []) => {
	let n = e === "open" ? 0 : 1;
	return z(["()", ...t].map((e) => e[n]).map(R).join("|"));
}, Zi = (e) => z(`${Ui(e).map(R).join("|")}`), Qi = ({ rest: e, dashes: t }) => e || t ? `(?![${e || ""}${t ? "-" : ""}])` : "", B = (e, t = {}) => {
	if (e.length === 0) return /^\b$/u;
	let n = Qi(t), r = Ui(e).map(R).join("|").replace(/ /gu, "\\s+");
	return RegExp(`(?:${r})${n}\\b`, "iuy");
}, $i = (e, t) => e.length ? z(`(?:${e.map(R).join("|")})(?:${t})`) : void 0, ea = {
	"``": "(?:`[^`]*`)+",
	"[]": String.raw`(?:\[[^\]]*\])(?:\][^\]]*\])*`,
	"\"\"-qq": String.raw`(?:"[^"]*")+`,
	"\"\"-bs": String.raw`(?:"[^"\\]*(?:\\.[^"\\]*)*")`,
	...
	"q''": (() => {
		let e = {
			...
			"(": ")",
			"{": "}"
		}, t = Object.entries(e).map(([e, t]) => "{left}(?:(?!{right}').)*?{right}".replace(/{left}/g, R(e)).replace(/{right}/g, R(t))), n = R(Object.keys(e).join(""));
		return `[Qq]'(?:${String.raw`(?<tag>[^\s${n}])(?:(?!\k<tag>').)*?\k<tag>`}|${t.join("|")})'`;
	})()
}, ta = (e) => typeof e == "string" ? ea[e] : "regex" in e ? e.regex : Ji(e) + ea[e.quote], na = (e) => z(e.map((e) => "regex" in e ? e.regex : ta(e)).join("|")), ra = (e) => e.map(ta).join("|"), ia = (e) => z(ra(e)), aa = (e = {}) => z(oa(e)), oa = ({ first: e, rest: t, dashes: n, allowFirstCharNumber: r } = {}) => {
	let i = "\\p{Alphabetic}\\p{Mark}_", a = "\\p{Decimal_Number}", o = R(e ?? ""), s = R(t ?? ""), c = r ? `[${i}${a}${o}][${i}${a}${s}]*` : `[${i}${o}][${i}${a}${s}]*`;
	return n ? qi(c) : c;
};
//#endregion
...
var ca = class {
	...
	createParseError() {
		let e = this.input.slice(this.index, this.index + 10), { line: t, col: n } = sa(this.input, this.index);
	...
	getWhitespace() {
		Gi.lastIndex = this.index;
		let e = Gi.exec(this.input);
...
}, la = /\/\*/uy, ua = /[\s\S]/uy, da = /\*\//uy, fa = class {
	constructor() {
		this.lastIndex = 0;
	}
	exec(e) {
		let t = "", n, r = 0;
		if (n = this.matchSection(la, e)) t += n, r++;
		else return null;
		for (; r > 0;) if (n = this.matchSection(la, e)) t += n, r++;
		else if (n = this.matchSection(da, e)) t += n, r--;
		else if (n = this.matchSection(ua, e)) t += n;
		else return null;
		return [t];
	}
	matchSection(e, t) {
	...
	buildRulesBeforeParams(e) {
		return this.validRules([
			...
			{
				type: O.LINE_COMMENT,
				regex: Yi(e.lineCommentTypes ?? ["--"])
			},
			{
				type: O.QUOTED_IDENTIFIER,
				regex: ia(e.identTypes)
			},
			{
				type: O.NUMBER,
			...
			},
			{
				...
				regex: B(e.reservedKeywordPhrases ?? [], e.identChars),
				text: V
			},
			{
				type: O.RESERVED_DATA_TYPE_PHRASE,
				regex: B(e.reservedDataTypePhrases ?? [], e.identChars),
				text: V
			},
			{
				type: O.CASE,
	...
	buildRulesAfterParams(e) {
		return this.validRules([
			{
				type: O.VARIABLE,
				regex: e.variableTypes ? na(e.variableTypes) : void 0
			},
			{
				type: O.STRING,
				regex: ia(e.stringTypes)
			},
			{
				type: O.IDENTIFIER,
				regex: aa(e.identChars)
			},
			{
				type: O.DELIMITER,
				regex: /[;]/uy
			...
			{
				type: O.OPEN_PAREN,
				regex: Xi("open", e.extraParens)
			},
			{
				type: O.CLOSE_PAREN,
				regex: Xi("close", e.extraParens)
			},
			{
				type: O.OPERATOR,
				regex: Zi([
			...
			},
			{
				...
				regex: Zi([".", ...e.propertyAccessOperators ?? []])
			}
		]);
	}
	buildParamRules(e, t) {
		...
		return this.validRules([
			{
				...
				regex: $i(n.named, oa(e.paramChars || e.identChars)),
				key: (e) => e.slice(1)
			},
			{
				type: O.QUOTED_PARAMETER,
				regex: $i(n.quoted, ra(e.identTypes)),
				key: (e) => (({ tokenKey: e, quoteChar: t }) => e.replace(new RegExp(R("\\" + t), "gu"), t))({
...
}, V = (e) => L(e.toUpperCase()), ma = /* @__PURE__ */ new Map(), ha = (e) => {
	let t = ma.get(e);
	return t || (t = ga(e), ma.set(e, t)), t;
}, ga = (e) => ({
	tokenizer: new pa(e.tokenizerOptions, e.name),
	formatOptions: _a(e)
}), _a = ({ tokenizerOptions: e, formatOptions: t }) => ({
...
function xa(e) {
	return e.map(Sa).map(Ca).map(wa).map(Ta).map(Ea);
}
var Sa = (e, t, n) => {
	if (de(e.type)) {
		let r = Da(n, t);
		if (r && r.type === O.PROPERTY_ACCESS_OPERATOR) return Object.assign(Object.assign({}, e), {
			type: O.IDENTIFIER,
			text: e.raw
		});
		let i = U(n, t);
		if (i && i.type === O.PROPERTY_ACCESS_OPERATOR) return Object.assign(Object.assign({}, e), {
			type: O.IDENTIFIER,
			text: e.raw
		});
	}
	...
	if (e.type === O.RESERVED_FUNCTION_NAME) {
		let r = U(n, t);
		if (!r || !Oa(r)) return Object.assign(Object.assign({}, e), {
			type: O.IDENTIFIER,
			text: e.raw
		});
	}
	...
	if (e.type === O.RESERVED_DATA_TYPE) {
		let r = U(n, t);
		if (r && Oa(r)) return Object.assign(Object.assign({}, e), { type: O.RESERVED_PARAMETERIZED_DATA_TYPE });
	}
	return e;
}, Ta = (e, t, n) => {
	if (e.type === O.IDENTIFIER) {
		let r = U(n, t);
		if (r && ka(r)) return Object.assign(Object.assign({}, e), { type: O.ARRAY_IDENTIFIER });
	}
	return e;
}, Ea = (e, t, n) => {
	if (e.type === O.RESERVED_DATA_TYPE) {
		let r = U(n, t);
		if (r && ka(r)) return Object.assign(Object.assign({}, e), { type: O.ARRAY_KEYWORD });
	}
	return e;
}, Da = (e, t) => U(e, t, -1), U = (e, t, n = 1) => {
	let r = 1;
	for (; e[t + r * n] && Aa(e[t + r * n]);) r++;
	return e[t + r * n];
}, Oa = (e) => e.type === O.OPEN_PAREN && e.text === "(", ka = (e) => e.type === O.OPEN_PAREN && e.text === "[", Aa = (e) => e.type === O.BLOCK_COMMENT || e.type === O.LINE_COMMENT, ja = class {
	constructor(e) {
	...
	save() {}
	formatError(e) {
		let { line: t, col: n } = sa(this.input, e.start);
...
var G = new ja((e) => []), K = ([[e]]) => e, q = (e) => ({
	...
	text: e.text,
	raw: e.raw
}), J = (e, { leading: t, trailing: n }) => (t?.length && (e = Object.assign(Object.assign({}, e), { leadingComments: t })), n?.length && (e = Object.assign(Object.assign({}, e), { trailingComments: n })), e), Pa = (e, { leading: t, trailing: n }) => {
	if (t?.length) {
		let [n, ...r] = e;
		e = [J(n, { leading: t }), ...r];
	}
	...
	ParserRules: [
		...
		},
		{
			...
			postprocess: () => ({ type: W.all_columns_asterisk })
		},
		{
		...
		},
		{
			...
			postprocess: ([e, t]) => J(e, { trailing: t })
		},
		{
			name: "_expression_with_comments",
			symbols: ["_", "expression"],
			postprocess: ([e, t]) => J(t, { leading: e })
		},
		{
		...
		},
		{
			...
			postprocess: ([e, t, n, r, [i]]) => ({
				type: W.property_access,
				object: J(e, { trailing: t }),
				operator: n.text,
				property: J(i, { leading: r })
			})
		},
		{
		...
		},
		{
			...
			postprocess: ([e, t, n, r, i]) => ({
				type: W.case_expression,
				caseKw: J(q(e), { trailing: t }),
				endKw: q(i),
				expr: n || [],
				clauses: r
			})
		},
		{
			...
			postprocess: ([e, t, n, r, i, a]) => ({
				type: W.case_when,
				whenKw: J(q(e), { trailing: t }),
				thenKw: J(q(r), { trailing: i }),
				condition: n,
				result: a
			})
		},
		...
		},
		{
			...
			postprocess: ([e, t, n]) => ({
				type: W.parameterized_data_type,
				dataType: J(Na(e), { trailing: t }),
				parenthesis: n
			})
		},
		{
	...
	ParserStart: "main"
}, { Parser: Ia, Grammar: La } = (/* @__PURE__ */ ae(ba(), 1)).default;
function Ra(e) {
	let t = {}, n = new ja((n) => [...xa(e.tokenize(n, t)), k(n.length)]), r = new Ia(La.fromCompiled(Fa), { lexer: n });
	return { parse: (e, n) => {
		t = n;
...
var za = class {
	...
	add(...e) {
		for (let t of e) switch (t) {
			...
			case Y.NO_NEWLINE:
				...
				break;
			case Y.NEWLINE:
				this.trimHorizontalWhitespace(), this.addNewline(Y.NEWLINE);
				break;
			...
			case Y.INDENT:
				this.addIndentation();
				break;
			case Y.SINGLE_INDENT:
				this.items.push(Y.SINGLE_INDENT);
				break;
			default: this.items.push(t);
		}
	}
	trimHorizontalWhitespace() {
		for (; Ba(I(this.items));) this.items.pop();
	}
	trimWhitespace() {
		for (; Va(I(this.items));) this.items.pop();
	}
	addNewline(e) {
		if (this.items.length > 0) switch (I(this.items)) {
			case Y.NEWLINE:
				...
				break;
			case Y.MANDATORY_NEWLINE: break;
			default: this.items.push(e);
		}
	}
	addIndentation() {
		for (let e = 0; e < this.indentation.getLevel(); e++) this.items.push(Y.SINGLE_INDENT);
	}
	toString() {
	...
	isAtStartOfLine() {
		for (let e = this.items.length - 1; e >= 0; e--) {
			let t = this.items[e];
			if (t !== Y.SINGLE_INDENT) return t === Y.NEWLINE || t === Y.MANDATORY_NEWLINE;
		}
		return !1;
	}
	itemToString(e) {
		switch (e) {
			case Y.SPACE: return " ";
			case Y.NEWLINE:
			case Y.MANDATORY_NEWLINE: return "\n";
			case Y.SINGLE_INDENT: return this.indentation.getSingleIndent();
			default: return e;
		}
	}
}, Ba = (e) => e === Y.SPACE || e === Y.SINGLE_INDENT, Va = (e) => e === Y.SPACE || e === Y.SINGLE_INDENT || e === Y.NEWLINE;
//#endregion
...
function Ua(e) {
	return fe(e) || e === O.RESERVED_CLAUSE || e === O.RESERVED_SELECT || e === O.RESERVED_SET_OPERATION || e === O.RESERVED_JOIN || e === O.LIMIT;
}
//#endregion
//#region node_modules/sql-formatter/dist/esm/formatter/Indentation.js
var Wa = "top-level", Ga = "block-level", Ka = class {
	constructor(e) {
	...
	decreaseTopLevel() {
		this.indentTypes.length > 0 && I(this.indentTypes) === Wa && this.indentTypes.pop();
	}
	decreaseBlockLevel() {
	...
	constructor(e) {
		super(new Ka("")), this.expressionWidth = e, this.length = 0, this.trailingSpace = !1;
	}
	add(...e) {
		if (e.forEach((e) => this.addToLength(e)), this.length > this.expressionWidth) throw new Ja();
		super.add(...e);
	}
	addToLength(e) {
		if (typeof e == "string") this.length += e.length, this.trailingSpace = !1;
		else if (e === Y.MANDATORY_NEWLINE || e === Y.NEWLINE) throw new Ja();
		else e === Y.INDENT || e === Y.SINGLE_INDENT || e === Y.SPACE ? this.trailingSpace ||= (this.length++, !0) : (e === Y.NO_NEWLINE || e === Y.NO_SPACE) && this.trailingSpace && (this.trailingSpace = !1, this.length--);
	}
}, Ja = class extends Error {}, Ya = class e {
	...
	formatNodeWithoutComments(e) {
		switch (e.type) {
			case W.function_call: return this.formatFunctionCall(e);
			case W.parameterized_data_type: return this.formatParameterizedDataType(e);
			case W.array_subscript: return this.formatArraySubscript(e);
			case W.property_access: return this.formatPropertyAccess(e);
			case W.parenthesis: return this.formatParenthesis(e);
			case W.between_predicate: return this.formatBetweenPredicate(e);
			case W.case_expression: return this.formatCaseExpression(e);
			case W.case_when: return this.formatCaseWhen(e);
			case W.case_else: return this.formatCaseElse(e);
			case W.clause: return this.formatClause(e);
			case W.set_operation: return this.formatSetOperation(e);
			case W.limit_clause: return this.formatLimitClause(e);
			case W.all_columns_asterisk: return this.formatAllColumnsAsterisk(e);
			case W.literal: return this.formatLiteral(e);
			case W.identifier: return this.formatIdentifier(e);
			case W.parameter: return this.formatParameter(e);
			case W.operator: return this.formatOperator(e);
			case W.comma: return this.formatComma(e);
			case W.line_comment: return this.formatLineComment(e);
			case W.block_comment: return this.formatBlockComment(e);
			case W.disable_comment: return this.formatBlockComment(e);
			case W.data_type: return this.formatDataType(e);
			case W.keyword: return this.formatKeywordNode(e);
		}
	}
	...
	formatPropertyAccess(e) {
		this.formatNode(e.object), this.layout.add(Y.NO_SPACE, e.operator), this.formatNode(e.property);
	}
	formatParenthesis(e) {
		let t = this.formatInlineExpression(e.children);
		t ? (this.layout.add(e.openParen), this.layout.add(...t.getLayoutItems()), this.layout.add(Y.NO_SPACE, e.closeParen, Y.SPACE)) : (this.layout.add(e.openParen, Y.NEWLINE), H(this.cfg) ? (this.layout.add(Y.INDENT), this.layout = this.formatSubExpression(e.children)) : (this.layout.indentation.increaseBlockLevel(), this.layout.add(Y.INDENT), this.layout = this.formatSubExpression(e.children), this.layout.indentation.decreaseBlockLevel()), this.layout.add(Y.NEWLINE, Y.INDENT, e.closeParen, Y.SPACE));
	}
	formatBetweenPredicate(e) {
		this.layout.add(this.showKw(e.betweenKw), Y.SPACE), this.layout = this.formatSubExpression(e.expr1), this.layout.add(Y.NO_SPACE, Y.SPACE, this.showNonTabularKw(e.andKw), Y.SPACE), this.layout = this.formatSubExpression(e.expr2), this.layout.add(Y.SPACE);
	}
	formatCaseExpression(e) {
		this.formatNode(e.caseKw), this.layout.indentation.increaseBlockLevel(), this.layout = this.formatSubExpression(e.expr), this.layout = this.formatSubExpression(e.clauses), this.layout.indentation.decreaseBlockLevel(), this.layout.add(Y.NEWLINE, Y.INDENT), this.formatNode(e.endKw);
	}
	formatCaseWhen(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT), this.formatNode(e.whenKw), this.layout = this.formatSubExpression(e.condition), this.formatNode(e.thenKw), this.layout = this.formatSubExpression(e.result);
	}
	formatCaseElse(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT), this.formatNode(e.elseKw), this.layout = this.formatSubExpression(e.result);
	}
	formatClause(e) {
		this.isOnelineClause(e) ? this.formatClauseInOnelineStyle(e) : H(this.cfg) ? this.formatClauseInTabularStyle(e) : this.formatClauseInIndentedStyle(e);
	}
	isOnelineClause(e) {
		return H(this.cfg) ? this.dialectCfg.tabularOnelineClauses[e.nameKw.text] : this.dialectCfg.onelineClauses[e.nameKw.text];
	}
	formatClauseInIndentedStyle(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e.nameKw), Y.NEWLINE), this.layout.indentation.increaseTopLevel(), this.layout.add(Y.INDENT), this.layout = this.formatSubExpression(e.children), this.layout.indentation.decreaseTopLevel();
	}
	formatClauseInOnelineStyle(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e.nameKw), Y.SPACE), this.layout = this.formatSubExpression(e.children);
	}
	formatClauseInTabularStyle(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e.nameKw), Y.SPACE), this.layout.indentation.increaseTopLevel(), this.layout = this.formatSubExpression(e.children), this.layout.indentation.decreaseTopLevel();
	}
	formatSetOperation(e) {
		this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e.nameKw), Y.NEWLINE), this.layout.add(Y.INDENT), this.layout = this.formatSubExpression(e.children);
	}
	formatLimitClause(e) {
		this.withComments(e.limitKw, () => {
			this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e.limitKw));
		}), this.layout.indentation.increaseTopLevel(), H(this.cfg) ? this.layout.add(Y.SPACE) : this.layout.add(Y.NEWLINE, Y.INDENT), e.offset ? (this.layout = this.formatSubExpression(e.offset), this.layout.add(Y.NO_SPACE, ",", Y.SPACE), this.layout = this.formatSubExpression(e.count)) : this.layout = this.formatSubExpression(e.count), this.layout.indentation.decreaseTopLevel();
	}
	formatAllColumnsAsterisk(e) {
		this.layout.add("*", Y.SPACE);
	}
	formatLiteral(e) {
		this.layout.add(e.text, Y.SPACE);
	}
	formatIdentifier(e) {
		this.layout.add(this.showIdentifier(e), Y.SPACE);
	}
	formatParameter(e) {
		this.layout.add(this.params.get(e), Y.SPACE);
	}
	formatOperator({ text: e }) {
		e === "-" && this.dialectCfg.identifierDashes ? this.layout.add(e, Y.SPACE) : this.cfg.denseOperators || this.dialectCfg.alwaysDenseOperators.includes(e) ? this.layout.add(Y.NO_SPACE, e) : e === ":" ? this.layout.add(Y.NO_SPACE, e, Y.SPACE) : this.layout.add(e, Y.SPACE);
	}
	formatComma(e) {
		this.inline ? this.layout.add(Y.NO_SPACE, ",", Y.SPACE) : this.layout.add(Y.NO_SPACE, ",", Y.NEWLINE, Y.INDENT);
	}
	withComments(e, t) {
	...
	formatComments(e) {
		e && e.forEach((e) => {
			e.type === W.line_comment ? this.formatLineComment(e) : this.formatBlockComment(e);
		});
	}
	formatLineComment(e) {
		Wi(e.precedingWhitespace || "") ? this.layout.add(Y.NEWLINE, Y.INDENT, e.text, Y.MANDATORY_NEWLINE, Y.INDENT) : this.layout.getLayoutItems().length > 0 ? this.layout.add(Y.NO_NEWLINE, Y.SPACE, e.text, Y.MANDATORY_NEWLINE, Y.INDENT) : this.layout.add(e.text, Y.MANDATORY_NEWLINE, Y.INDENT);
	}
	formatBlockComment(e) {
		e.type === W.block_comment && this.isStandaloneBlockComment(e) ? (this.splitBlockComment(e.text).forEach((e) => {
			this.layout.add(Y.NEWLINE, Y.INDENT, e);
		}), this.layout.add(Y.NEWLINE, Y.INDENT)) : this.layout.add(e.text, Y.SPACE);
	}
	isStandaloneBlockComment(e) {
		return Wi(e.text) || Wi(e.precedingWhitespace || "") || this.layout.isAtStartOfLine();
	}
	isDocComment(e) {
		let t = e.split(/\n/);
	...
	formatInlineExpression(t) {
		...
		try {
			return new e({
				...
				dialectCfg: this.dialectCfg,
				params: this.params,
				layout: new qa(this.cfg.expressionWidth),
				inline: !0
			}).format(t);
		} catch (e) {
			if (e instanceof Ja) {
	...
	formatKeywordNode(e) {
		switch (e.tokenType) {
			case O.RESERVED_JOIN: return this.formatJoin(e);
			case O.AND:
			case O.OR:
			case O.XOR: return this.formatLogicalOperator(e);
			default: return this.formatKeyword(e);
		}
	}
	formatJoin(e) {
		H(this.cfg) ? (this.layout.indentation.decreaseTopLevel(), this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e), Y.SPACE), this.layout.indentation.increaseTopLevel()) : this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e), Y.SPACE);
	}
	formatKeyword(e) {
		this.layout.add(this.showKw(e), Y.SPACE);
	}
	formatLogicalOperator(e) {
		this.cfg.logicalOperatorNewline === "before" ? H(this.cfg) ? (this.layout.indentation.decreaseTopLevel(), this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e), Y.SPACE), this.layout.indentation.increaseTopLevel()) : this.layout.add(Y.NEWLINE, Y.INDENT, this.showKw(e), Y.SPACE) : this.layout.add(this.showKw(e), Y.NEWLINE, Y.INDENT);
	}
	formatDataType(e) {
		this.layout.add(this.showDataType(e), Y.SPACE);
	}
	showKw(e) {
		return Ua(e.tokenType) ? Ha(this.showNonTabularKw(e), this.cfg.indentStyle) : this.showNonTabularKw(e);
	}
	showNonTabularKw(e) {
	...
	showFunctionKw(e) {
		return Ua(e.tokenType) ? Ha(this.showNonTabularFunctionKw(e), this.cfg.indentStyle) : this.showNonTabularFunctionKw(e);
	}
	...
	constructor(e, t) {
		this.dialect = e, this.cfg = t, this.params = new ya(this.cfg.params);
	}
	format(e) {
		let t = this.parse(e);
	...
	parse(e) {
		return Ra(this.dialect.tokenizer).parse(e, this.cfg.paramTypes || {});
	}
	formatAst(e) {
	...
	formatStatement(e) {
		let t = new Ya({
			...
			params: this.params,
			layout: new za(new Ka(va(this.cfg)))
		}).format(e.children);
		return e.hasSemicolon && (this.cfg.newlineBeforeSemicolon ? t.add(Y.NEWLINE, ";") : t.add(Y.NO_NEWLINE, ";")), t.toString();
	}
...
function Za(e) {
	for (let t of [
		...
		"commaPosition",
		"tabulateAlias"
	]) if (t in e) throw new X(`${t} config is no more supported.`);
	if (e.expressionWidth <= 0) throw new X(`expressionWidth config must be positive number. Received ${e.expressionWidth} instead.`);
	if (e.params && !Qa(e.params) && console.warn("WARNING: All \"params\" option values should be strings."), e.paramTypes && !$a(e.paramTypes)) throw new X("Empty regex given in custom paramTypes. That would result in matching infinite amount of parameters.");
	return e;
}
function Qa(e) {
...
var eo = function(e, t) {
	...
	if (typeof t.language == "string" && !no.includes(t.language)) throw new X(`Unsupported SQL dialect: ${t.language}`);
	let n = to[t.language || "sql"];
	return ao(e, Object.assign(Object.assign({}, t), { dialect: Hi[n] }));
}, ao = (e, t) => {
	var { dialect: n } = t, r = eo(t, ["dialect"]);
	if (typeof e != "string") throw Error("Invalid query argument. Expected string, instead got " + typeof e);
	let i = Za(Object.assign(Object.assign({}, ro), r));
	return new Xa(ha(n), i).format(e);
}, Z = "/apps/lens-kiro-crew-app/api";
function oo(t = 560) {
	let [r, i] = n(() => window.matchMedia(`(max-width: ${t}px)`).matches);
	return e(() => {
		let e = window.matchMedia(`(max-width: ${t}px)`), n = (e) => i(e.matches);
		return e.addEventListener("change", n), () => e.removeEventListener("change", n);
	}, [t]), r;
}
function so({ label: e, sub: t, value: n, max: r, narrow: i, onLabelClick: a }) {
	let o = t ? /* @__PURE__ */ g("span", {
		className: "text-[10px] px-1.5 py-0.5 rounded bg-border text-muted whitespace-nowrap truncate",
		children: t
	}) : /* @__PURE__ */ g("span", {
	...
	return i ? /* @__PURE__ */ _("div", {
		...
		children: [/* @__PURE__ */ _("div", {
			...
			children: [
				...
				o,
				/* @__PURE__ */ g("span", {
					className: "shrink-0 text-right text-[11px] text-muted whitespace-nowrap",
		...
		children: [
			...
			/* @__PURE__ */ _("div", {
				...
				style: { flexBasis: "clamp(120px, 30%, 320px)" },
				children: [/* @__PURE__ */ g("div", {
					className: "flex-1 min-w-0",
					children: s
				}), /* @__PURE__ */ g("span", {
					className: "w-12 shrink-0 text-right text-[11px] text-muted whitespace-nowrap",
					children: n.toLocaleString()
				})]
			})
		]
...
function co({ rows: e = 6 }) {
	return /* @__PURE__ */ g("div", {
		className: "flex flex-col gap-2",
		children: Array.from({ length: e }).map((e, t) => /* @__PURE__ */ _("div", {
			className: "flex items-center gap-2",
			children: [
				/* @__PURE__ */ g("div", {
					className: "flex-1 min-w-0",
					children: /* @__PURE__ */ g(l, { className: "h-4 w-3/4" })
				}),
				/* @__PURE__ */ g("div", {
					className: "w-24 shrink-0 flex justify-end",
					children: /* @__PURE__ */ g(l, { className: "h-4 w-16" })
				}),
				/* @__PURE__ */ _("div", {
					...
					children: [/* @__PURE__ */ g("div", {
						...
						children: /* @__PURE__ */ g(l, {
							className: "h-2",
							style: { width: `${75 - t * 23 % 55}%` }
						})
					}), /* @__PURE__ */ g("div", {
						className: "w-12 shrink-0 flex justify-end",
						children: /* @__PURE__ */ g(l, { className: "h-3 w-8" })
					})]
				})
			]
		}, t))
...
function lo(e) {
	...
	let t = new Map(e.map((e) => [e.day.slice(0, 10), e.sessions])), n = /* @__PURE__ */ new Date(`${e[e.length - 1].day.slice(0, 10)}T00:00:00Z`);
	return Array.from({ length: 14 }).map((e, r) => {
		let i = new Date(n);
		i.setUTCDate(n.getUTCDate() - (13 - r));
		let a = i.toISOString().slice(0, 10);
		return {
			day: a,
			sessions: t.get(a) ?? 0
		};
...
function uo({ days: e }) {
	let t = Math.max(1, ...e.map((e) => e.sessions)), n = new Intl.DateTimeFormat(void 0, {
		month: "2-digit",
		day: "2-digit"
	...
	return /* @__PURE__ */ g("div", {
		...
		style: { height: "112px" },
		children: e.map((i, a) => {
			let o = /* @__PURE__ */ new Date(`${i.day}T00:00:00`), s = (e.length - 1 - a) % 5 == 0, c = a < 2 ? "left-0" : a > e.length - 3 ? "right-0" : "left-1/2 -translate-x-1/2";
			return /* @__PURE__ */ _("div", {
				className: "relative flex-1 flex flex-col items-center gap-1 min-w-0 group",
				children: [
					/* @__PURE__ */ _("div", {
						className: `absolute bottom-full mb-1.5 ${c} px-2.5 py-1.5 rounded-md border border-border bg-card shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10`,
						role: "tooltip",
						children: [/* @__PURE__ */ g("div", {
					...
					/* @__PURE__ */ g("div", {
						...
						style: {
							height: `${i.sessions / t * 72}px`,
							minHeight: i.sessions > 0 ? "3px" : "1px",
							background: i.sessions > 0 ? "var(--accent)" : "var(--border)"
						}
					}),
					/* @__PURE__ */ g("span", {
						className: "text-[10px] text-muted leading-none h-2.5 whitespace-nowrap",
						children: s ? n.format(o) : ""
					})
				]
			}, i.day);
		})
...
function fo() {
	return /* @__PURE__ */ g("div", {
		className: "flex items-end gap-1.5",
		style: { height: "112px" },
		children: Array.from({ length: 14 }).map((e, t) => /* @__PURE__ */ _("div", {
			className: "flex-1 flex flex-col items-center gap-1",
			children: [/* @__PURE__ */ g(l, {
				className: "w-full rounded-t",
				style: { height: `${16 + t * 29 % 56}px` }
			}), /* @__PURE__ */ g("div", {
				className: "h-2.5",
				children: (13 - t) % 5 == 0 && /* @__PURE__ */ g(l, { className: "h-2.5 w-7" })
			})]
		}, t))
	});
}
var po = 200;
function mo(e) {
	let t = String(e?.message ?? e ?? "").replace(/\s+/g, " ").trim();
	if (!t) return "Request failed";
	let [, n = "", r = t] = /^API (\d{3}):\s*([\s\S]*)$/.exec(t) ?? [], i = r.trim();
	return /<!doctype|<html/i.test(i) && (i = /<title[^>]*>([^<]+)<\/title>/i.exec(i)?.[1]?.trim() || "server returned an HTML error page"), i.length > po && (i = `${i.slice(0, 199)}…`), [n && `API ${n}`, i || "request failed"].filter(Boolean).join(": ");
}
function ho() {
	let t = r(), [i, s] = n(null);
	return e(() => {
		let e = !0;
		return t.get(`${Z}/setup`).then((t) => {
			e && s(t);
		}).catch(() => {}), () => {
			e = !1;
		};
	}, []), i ? i.ok && (i.sources.sessions ?? 0) === 0 ? /* @__PURE__ */ _(a, {
		className: "mt-6",
		children: [/* @__PURE__ */ g(o, { children: "No session records found" }), /* @__PURE__ */ _("div", {
			className: "flex gap-2 text-sm items-start mt-2",
			children: [/* @__PURE__ */ g("span", {
				...
				children: "Lens could not find local Kiro Crew session records. Confirm that this account has existing sessions and restart Lens."
			})]
		})]
	}) : i.ok ? /* @__PURE__ */ _("div", {
		...
		children: [/* @__PURE__ */ _("span", {
			...
			children: [
				...
				i.engine.version,
				" · ",
				i.sources.sessions ?? 0,
				" session files"
			]
		})]
	}) : /* @__PURE__ */ _(a, {
		className: "mt-6",
		children: [/* @__PURE__ */ g(o, { children: "Setup needed" }), /* @__PURE__ */ _("div", {
			className: "flex gap-2 text-sm items-start mt-2",
			children: [/* @__PURE__ */ g("span", {
				style: {
					color: "var(--warn)",
				...
				children: /* @__PURE__ */ g(d, { size: 14 })
			}), /* @__PURE__ */ _("div", { children: [/* @__PURE__ */ g("div", { children: i.engine.available ? "The query service could not initialize." : "DuckDB is not installed." }), /* @__PURE__ */ _("div", {
				className: "text-[12px] mt-0.5",
				style: { color: "var(--muted)" },
				children: [
					"Reinstall Lens from its source directory with ",
					((e) => /* @__PURE__ */ g("code", {
					...
					i.query.error ? ` ${mo(i.query.error)}` : ""
				]
			})] })]
		})]
	}) : null;
...
function Q(e) {
	return e == null || !isFinite(e) ? "—" : e < 1e3 ? `${Math.round(e)}ms` : `${(e / 1e3).toFixed(1)}s`;
}
function go(e) {
	let t = (e || "").trim();
	if (!t) return t;
...
function _o({ narrow: t }) {
	let i = r(), [s, c] = n(null), [l, u] = n(null);
	if (e(() => {
		let e = !0;
		return i.get(`${Z}/slow-queries`).then((t) => {
			e && c(t);
		}).catch(() => {}), () => {
			e = !1;
		};
	}, []), !s) return null;
	let { summary: d, top: f } = s;
	if (!d.calls) return /* @__PURE__ */ _(a, {
		className: "mt-3",
		children: [/* @__PURE__ */ g(o, { children: "Query cost" }), /* @__PURE__ */ _("p", {
			className: "text-sm text-muted mt-1 mb-0",
			children: [
				"No queries traced yet. Every ",
				/* @__PURE__ */ g("code", { children: "kc-lens" }),
				" query records one bounded local timing row."
			]
		})]
	});
	let m = Math.max(1, ...f.map((e) => e.total_ms)), h = "minmax(0,1fr) 130px 46px 66px clamp(150px, 26%, 300px)";
	return /* @__PURE__ */ _(a, {
		className: "mt-3",
		children: [
			/* @__PURE__ */ g(o, { children: "Query cost" }),
			/* @__PURE__ */ g("p", {
				className: "text-[11px] text-muted mt-1 mb-2",
				children: "Ranked by total time (calls × duration)."
			}),
			/* @__PURE__ */ _("div", {
				className: "flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-muted mb-3",
				children: [
					/* @__PURE__ */ _("span", { children: [/* @__PURE__ */ g("span", {
						className: "text-accent",
						children: d.calls.toLocaleString()
					}), " queries"] }),
					/* @__PURE__ */ _("span", { children: [/* @__PURE__ */ g("span", {
						className: "text-accent",
						children: d.shapes
					}), " shapes"] }),
					/* @__PURE__ */ _("span", { children: ["median ", /* @__PURE__ */ g("span", {
						className: "text-accent",
						children: Q(d.median_ms)
					})] }),
					/* @__PURE__ */ _("span", { children: ["p95 ", /* @__PURE__ */ g("span", {
						className: "text-accent",
						children: Q(d.p95_ms)
					})] }),
					/* @__PURE__ */ _("span", {
						title: "Wall-clock timing: every figure includes query-engine startup.",
						children: ["floor ", /* @__PURE__ */ g("span", {
							className: "text-accent",
							children: Q(d.floor_ms)
						})]
					}),
					d.errors > 0 && /* @__PURE__ */ _("span", {
						style: { color: "var(--warn)" },
						children: [d.errors, " failed"]
					}),
					d.since && /* @__PURE__ */ _("span", { children: ["since ", d.since.slice(0, 16)] })
				]
			}),
			!t && /* @__PURE__ */ _("div", {
				...
				children: [
					/* @__PURE__ */ g("span", { children: "query shape" }),
					/* @__PURE__ */ g("span", { children: "caller" }),
					/* @__PURE__ */ g("span", {
			...
			/* @__PURE__ */ g("div", {
				...
				children: f.map((e) => {
					let n = l === e.sql_fp, r = (e.slowest_sql || "").replace(/\s+/g, " ").trim();
					return /* @__PURE__ */ _("div", {
						className: "border-b border-border last:border-0",
						children: [/* @__PURE__ */ _("button", {
							type: "button",
							onClick: () => u(n ? null : e.sql_fp),
							"aria-expanded": n,
							title: r,
							className: "w-full text-left",
							style: {
								display: t ? "flex" : "grid",
								gridTemplateColumns: t ? void 0 : h,
								flexDirection: t ? "column" : void 0,
								gap: t ? "3px" : "12px",
							...
							children: [
								...
								!t && /* @__PURE__ */ g("span", {
									...
									title: e.callers || "unknown",
									children: e.callers || "unknown"
								}),
								!t && /* @__PURE__ */ _("span", {
									className: "text-[11px] text-muted",
									style: {
								...
								/* @__PURE__ */ _("span", {
									...
									children: [/* @__PURE__ */ g("span", {
										...
										children: /* @__PURE__ */ g("span", { style: {
											display: "block",
											width: `${e.total_ms / m * 100}%`,
											minWidth: "3px",
											height: "6px",
											borderRadius: "3px",
											background: e.errors > 0 ? "var(--warn)" : "var(--accent)"
										} })
									}), /* @__PURE__ */ g("span", {
										className: "text-[11px]",
										style: {
							...
							children: [/* @__PURE__ */ _("div", {
								...
								children: [
									/* @__PURE__ */ g("span", { children: e.callers || "unknown caller" }),
									/* @__PURE__ */ _("span", { children: [e.calls, "× calls"] }),
									/* @__PURE__ */ _("span", { children: ["median ", Q(e.median_ms)] }),
									/* @__PURE__ */ _("span", { children: ["max ", Q(e.max_ms)] }),
									e.errors > 0 && /* @__PURE__ */ _("span", {
										style: { color: "var(--warn)" },
										children: [e.errors, " failed"]
									}),
									e.last_seen && /* @__PURE__ */ _("span", { children: ["last ", e.last_seen.slice(0, 16)] })
								]
							}), /* @__PURE__ */ g("pre", {
								...
								children: e.slowest_sql ? go(e.slowest_sql) : "(no SQL recorded)"
							})]
						})]
					}, e.sql_fp);
				})
...
var $ = 4;
function vo({ skill: e }) {
	let t = e.content.split("\n"), r = e.coverage || [], i = r.reduce((e, t) => Math.max(e, t), 0), a = e.partial_reads ?? 0, o = Math.min(a, $) / $, s = e.pre_edit_excluded ?? 0, c = e.since, [l, u] = n(null);
	return /* @__PURE__ */ _(h, { children: [/* @__PURE__ */ _("div", {
		className: "text-[11px] mb-2 flex items-center gap-2 flex-wrap",
		style: { color: "var(--muted)" },
		children: [
			r.length === 0 ? /* @__PURE__ */ g("span", { children: "read-coverage estimate unavailable" }) : i === 0 ? /* @__PURE__ */ g("span", { children: "only whole-file reads recorded, so nothing is truncated" }) : /* @__PURE__ */ _("span", {
				className: "flex items-center gap-1",
				style: { cursor: "help" },
				title: "Partial read: a head -N or offset+limit read that stops before the end of the file. Whole-file reads are excluded from the heat.",
				children: [
					"rarely truncated",
			...
			i > 0 && a < $ && /* @__PURE__ */ _("span", {
				title: `Only ${a} partial read${a === 1 ? "" : "s"} since the last edit — too few to rank lines confidently, so the heat is faded. It darkens as more partial reads accumulate (full strength at ${$}).`,
				children: [
					"faded (",
					a,
					" partial read",
			...
			s > 0 && c && /* @__PURE__ */ _("span", {
				title: `Reads from before the last edit (${c}) are excluded: their line numbers referenced an older version of this file.`,
				children: [
					s,
					" pre-edit read",
					s === 1 ? "" : "s",
		...
		children: [t.map((e, t) => {
			let n = r[t] || 0, a = i > 0 ? (i - n) / i : 0, s = a * o, c = a > 0;
			return /* @__PURE__ */ _("div", {
				style: {
					display: "flex",
					alignItems: "stretch",
					position: "relative",
					background: c ? `color-mix(in srgb, var(--danger) ${Math.round(s * 18)}%, transparent)` : "transparent"
				},
				children: [
					/* @__PURE__ */ g("span", {
						onMouseEnter: c ? () => u(t) : void 0,
						onMouseLeave: c ? () => u((e) => e === t ? null : e) : void 0,
						style: {
							flex: "0 0 12px",
							display: "flex",
							alignItems: "stretch",
...
function yo({ skill: t, name: n, loadingName: r, error: i, onClose: a }) {
	return e(() => {
		let e = (e) => {
			e.key === "Escape" && a();
		};
		return window.addEventListener("keydown", e), () => window.removeEventListener("keydown", e);
	}, [a]), n ? /* @__PURE__ */ _(h, { children: [/* @__PURE__ */ g("div", {
		onClick: a,
		style: {
			position: "fixed",
			inset: 0,
		...
		children: [/* @__PURE__ */ _("div", {
			...
			children: i ? /* @__PURE__ */ g("p", {
				...
				className: "flex flex-col gap-2",
				children: [
					/* @__PURE__ */ g(l, { className: "h-4 w-3/4" }),
					/* @__PURE__ */ g(l, { className: "h-4 w-full" }),
					/* @__PURE__ */ g(l, { className: "h-4 w-5/6" })
				]
			}) : t ? /* @__PURE__ */ g(vo, { skill: t }) : null
		})]
	})] }) : null;
}
function bo() {
	let d = r(), f = oo(), [ee, v] = n(null), [te, ne] = n(null), [re, y] = n(null), [ie, b] = n(null), x = t(0);
	async function ae(e) {
		let t = ++x.current;
		b(null), v(null), ne(e), y(e);
		try {
			let n = await d.get(`${Z}/skill?name=${encodeURIComponent(e)}`);
			t === x.current && v(n);
		} catch (e) {
			t === x.current && b(mo(e));
		} finally {
	...
	let S = () => {
		x.current++, v(null), ne(null), b(null), y(null);
	}, [C, oe] = n(null), [se, w] = n([]), [T, ce] = n(null), [E, le] = n(!0), [D, ue] = n(!1);
	e(() => {
		let e = !0;
		return Promise.all([d.get(`${Z}/overview`), d.get(`${Z}/catalog`)]).then(([t, n]) => {
			e && (oe(t), w(n.views || []));
		}).catch((t) => {
			e && ce(mo(t));
		}).finally(() => {
	...
	let O = C?.totals || {}, k = C?.sessions_by_day || [], A = C?.top_tools || [], j = C?.skill_reads || [], M = Math.max(1, ...A.map((e) => e.calls)), de = Math.max(1, ...j.map((e) => e.reads));
	return /* @__PURE__ */ _(h, { children: [/* @__PURE__ */ g(c, {
		title: "Lens",
		subtitle: "Kiro Crew session history, queryable"
	}), /* @__PURE__ */ _("div", {
		className: "px-6 pb-8 flex-1 min-h-0",
		children: [
			T && /* @__PURE__ */ g("div", {
				className: "mb-6",
				children: /* @__PURE__ */ g(s, {
					icon: /* @__PURE__ */ g(m, { size: 40 }),
					title: "Couldn't reach the session database",
					subtitle: `Lens could not load your local history. No activity totals are shown until the connection is restored. ${T}`
				})
			}),
			/* @__PURE__ */ g(ho, {}),
			!T && /* @__PURE__ */ _(h, { children: [
				/* @__PURE__ */ _("div", {
					className: "grid gap-3.5 grid-cols-[repeat(auto-fit,minmax(150px,1fr))] mb-4",
					children: [
						/* @__PURE__ */ g(u, {
							label: "Sessions",
							value: E ? void 0 : O.sessions ?? 0,
							accent: !0
						}),
						/* @__PURE__ */ g(u, {
							label: "Messages",
							value: E ? void 0 : O.messages ?? 0
						}),
						/* @__PURE__ */ g(u, {
							label: "Tool calls",
							value: E ? void 0 : O.tool_calls ?? 0
						})
					]
				}),
				/* @__PURE__ */ g("div", {
					className: "mt-3",
					children: /* @__PURE__ */ _(a, { children: [
						/* @__PURE__ */ _("button", {
							type: "button",
							className: "w-full flex items-center justify-between text-left",
							onClick: () => ue((e) => !e),
							"aria-expanded": D,
							children: [/* @__PURE__ */ g(o, { children: "Query catalog" }), /* @__PURE__ */ g("span", {
								...
								children: /* @__PURE__ */ g(p, {
									size: 16,
									style: {
										transform: D ? "rotate(90deg)" : "none",
										transition: "transform 0.15s"
									}
								})
							})]
						}),
						E ? /* @__PURE__ */ g(l, { className: "h-4 w-72 mt-1" }) : /* @__PURE__ */ _("p", {
							className: "text-sm text-muted mt-1 mb-0",
							children: [
								se.length,
								" views over your local Kiro Crew records. Ask the Lens agent to analyze your local history. Queries can read message text, tool inputs and outputs, and file-edit contents; ask for a narrow time range or topic to limit exposure. For example:",
								" ",
								/* @__PURE__ */ g("span", {
									className: "text-accent",
									children: "“Use the Lens SQL tool to show my top tools this week.”"
								})
							]
						}),
						D && !E && /* @__PURE__ */ g("div", {
							className: "flex flex-col gap-3 mt-3",
							children: se.map((e) => /* @__PURE__ */ _("div", {
								...
								children: [/* @__PURE__ */ _("div", {
									...
									className: "text-[11px] text-muted mt-1 flex flex-wrap gap-1",
									children: e.columns.map((e) => /* @__PURE__ */ g("span", {
										style: {
											border: "1px solid var(--border)",
											borderRadius: "4px",
											padding: "0 5px"
				...
				/* @__PURE__ */ _("div", {
					className: "grid gap-3 lg:grid-cols-2 mb-3",
					children: [/* @__PURE__ */ _(a, { children: [/* @__PURE__ */ g(o, { children: "Top tools" }), E ? /* @__PURE__ */ g(co, { rows: 8 }) : A.length === 0 ? /* @__PURE__ */ g("p", {
						className: "text-sm text-muted",
						children: "No tool calls were found in the session files Lens can currently read."
					}) : /* @__PURE__ */ g("div", {
						className: "flex flex-col gap-1.5",
						children: A.map((e) => /* @__PURE__ */ g(so, {
							label: e.tool_name,
							sub: e.tool_server,
							value: e.calls,
							max: M,
							narrow: f
						}, `${e.tool_name}|${e.tool_server ?? ""}`))
					})] }), /* @__PURE__ */ _(a, { children: [
						/* @__PURE__ */ g(o, { children: "Skill reads" }),
						/* @__PURE__ */ g("p", {
							className: "text-[11px] text-muted mb-2",
							children: "SKILL.md files the agent opened."
						}),
						E ? /* @__PURE__ */ g(co, { rows: 8 }) : j.length === 0 ? /* @__PURE__ */ g("p", {
							className: "text-sm text-muted",
							children: "No skill reads recorded."
						}) : /* @__PURE__ */ g("div", {
							className: "flex flex-col gap-1.5",
							children: j.map((e) => /* @__PURE__ */ g(so, {
								label: e.skill,
								sub: e.last_read,
								value: e.reads,
								max: de,
								narrow: f,
								onLabelClick: () => ae(e.skill)
							}, e.skill))
						})
					] })]
				}),
				/* @__PURE__ */ g(_o, { narrow: f }),
				/* @__PURE__ */ _(a, { children: [/* @__PURE__ */ _("div", {
					style: {
						display: "flex",
						alignItems: "baseline",
						gap: "8px"
					},
					children: [/* @__PURE__ */ g(o, { children: "Sessions" }), /* @__PURE__ */ g("span", {
						className: "text-[11px] text-muted",
						children: "last 14 days"
					})]
				}), E ? /* @__PURE__ */ g(fo, {}) : k.length === 0 ? /* @__PURE__ */ g("p", {
					className: "text-sm text-muted",
					children: "No sessions were found in the last 14 days."
				}) : /* @__PURE__ */ g(uo, { days: lo(k) })] })
			] }),
			/* @__PURE__ */ g(yo, {
				skill: ee,
				name: te,
